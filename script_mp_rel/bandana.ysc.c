						...
						else
						{
							...
							else
							{
								if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_3, 822176400) || uParam0->f_4)
								{
									...
									if ((func_14(uParam0->f_1) == 81053684 || func_15(uParam0->f_1, 160827531)) && !func_15(uParam0->f_1, -1303648999))
									{
								...
								else
								{
									if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_3, 822176400) || uParam0->f_4)
									{
										...
										if (func_14(uParam0->f_1) == 81053684 || func_15(uParam0->f_1, 160827531))
										{
...
void func_10(var uParam0)
{
	...
	if (bVar3)
	{
		...
		else if (bVar2)
		{
			if (bVar5)
			{
				if ((bVar4 == 81053684 || func_15(uParam0->f_1, 160827531)) && !func_15(uParam0->f_1, -1303648999))
				{
		...
		else if (((bVar4 == 81053684 || func_15(uParam0->f_1, 160827531)) && func_28(uParam0->f_6, 2)) && !func_15(uParam0->f_1, -1303648999))
		{
...
void func_16(int iParam0, bool bParam1)
{
	...
	if (func_14(bParam1) != 81053684 && !func_15(bParam1, 160827531))
	{
...
void func_17(int iParam0, bool bParam1)
{
	...
	if (func_14(bParam1) != -525676072 && !func_15(bParam1, -1303648999))
	{
...
int func_23(bool bParam0, int iParam1)
{
	...
	if (func_14(bParam0) == -525676072 || func_15(bParam0, -1303648999))
	{
		bVar1 = true;
	}
	if (bVar3)
	...
	{
		if (func_15(bVar2, -1303648999) || func_14(bVar2) == -525676072)
		{
...
bool func_26(bool bParam0)
{
	...
	if (-1829635046 == func_44(81053684))
	{
	...
	else if (func_37(-525676072, bParam0) || func_15(func_45(1742327865), -1303648999))
	{
...
void func_30(bool bParam0, char* sParam1)
{
	...
	if ((iVar1 == 1108822547 && func_52(32768)) || bParam0 != Global_1953612.f_1694.f_1[iVar2 /*3*/])
	{
		...
		{
			case 81053684:
				if (func_37(-525676072, &uVar0))
				{
					iVar3 = func_49(func_53(-525676072), 1);
					if (iVar3 == 39)
					{
					...
					else
					{
						...
						if (func_15(bParam0, -180472385) && func_37(1024667707, &uVar0))
						{
							...
							else
							{
								...
								if (func_37(81053684, &uVar4))
								{
									iVar3 = func_49(func_53(81053684), 1);
									if (iVar3 == 39)
									{
...
bool func_37(bool bParam0, bool bParam1)
{
	...
	if (Global_1953612.f_1694.f_1[iVar1 /*3*/] != 0 && Global_1953612.f_1694.f_1[iVar1 /*3*/] != Global_1953612.f_83[iVar1 /*12*/])
	{
		...
		if (func_14(bVar0) == bParam0 || (bParam0 == 81053684 && func_15(bVar0, 160827531)))
		{
			*bParam1 = bVar0;
			return true;
		}
...
bool func_43(bool bParam0)
{
	...
	if (((iVar0 == 81053684 || iVar0 == -525676072) || func_15(bParam0, 160827531)) || func_15(bParam0, -1303648999))
	{
