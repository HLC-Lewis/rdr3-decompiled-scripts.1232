...
bool func_54(var uParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(680, 162, "[WEAPON_LOCKER][UI_EVENT][WEAPON_MOVE_PLAYER] - Request to move Weapon: ", func_76(bVar0), " To attach point: ", func_77(iParam1, 0));
	if (!func_78(bVar0, bVar1, iParam1))
	{
...
bool func_56(var uParam0)
{
	...
	bVar1 = DATABINDING::_DATABINDING_READ_DATA_HASH_STRING_FROM_PARENT(*uParam0, "inventory_item_slot");
	DEBUG::_0xA308F935BDECCEC0(2728, 162, "[WEAPON_LOCKER][UI_EVENT][WEAPON_MOVE_LOCKER] - Request to move Weapon: ", func_76(bVar0), " Slot: ", func_82(bVar1, 0), " To locker.");
	Var2 = { func_71(bVar0, func_70(0), bVar1, 0) };
	if (!func_72(&Var2))
	{
...
bool func_57(var uParam0)
{
	...
	bVar1 = DATABINDING::_DATABINDING_READ_DATA_HASH_STRING_FROM_PARENT(*uParam0, "inventory_item_slot");
	DEBUG::_0xA308F935BDECCEC0(2728, 162, "[WEAPON_LOCKER][UI_EVENT][WEAPON_MOVE_HORSE] - Request to move Weapon: ", func_76(bVar0), " Slot: ", func_82(bVar1, 0), " To horse.");
	Var2 = { func_71(bVar0, func_70(0), bVar1, 0) };
	if (!func_72(&Var2))
	{
...
bool func_63(int* iParam0, int iParam1)
{
	...
	while (iVar19 < 7)
	{
		...
		while (bVar18 < iVar1)
		{
			...
			if (!func_89(&Var2, bVar18, sVar0, iVar1))
			{
				DEBUG::_0x83407B92D46F25C3(8, 162, "[WEAPON_LOCKER][WEAPON_LIST] - ERROR! Failed to ge the item from Collection: ", sVar0);
			}
			else if (!func_90(Var2.f_4))
			{
				DEBUG::_0xA308F935BDECCEC0(648, 162, "[WEAPON_LOCKER][WEAPON_LIST] - ERROR! Not a valid weapon at index: ", bVar18, " Name: ", func_76(Var2.f_4));
			}
			else if (func_91(Var2.f_4) != iVar19)
			{
				DEBUG::_0xA308F935BDECCEC0(10920, 162, "[WEAPON_LOCKER][WEAPON_LIST] - Item: ", func_92(Var2.f_4, 0), " Filter: ", func_88(func_91(Var2.f_4), 0), " !=!=!= Has not passed the filter. ", func_88(iVar19, 0));
			}
			else
			{
				iVar16 = func_93(&Var2);
						...
						case -1:
							...
							else
							{
								...
								else
								{
									...
									{
										DEBUG::_0xA308F935BDECCEC0(40, 162, "[WEAPON_LOCKER][WEAPON_LIST] Weapon: ", func_76(Var2.f_4));
										...
										if (!func_96(iParam0, bVar17, Var2.f_4, Var2.f_9, iVar16, iParam1))
										{
...
struct<4> func_70(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		if (!INVENTORY::_0xB881CA836CC4B6D4(&(Global_1272425.f_4)))
		{
			...
			Global_1272425.f_4 = { func_71(923904168, func_110(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		if (!INVENTORY::_0xB881CA836CC4B6D4(&(Global_1272425.f_16)))
		{
			...
			Global_1272425.f_16 = { func_71(923904168, func_110(bParam0), -740156546, 0) };
		}
		return Global_1272425.f_16;
	}
	return func_71(923904168, func_110(bParam0), -740156546, 0);
}
...
int func_73(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
...
bool func_78(bool bParam0, bool bParam1, int iParam2)
{
	int iVar0;
	struct<4> Var1;
	struct<15> Var5;
	...
	DEBUG::_0xA308F935BDECCEC0(10920, 162, "[WEAPON_LOCKER][WEAPON_MOVE_TO_PLAYER] Moving weapon: ", func_92(bParam0, 0), " In Slot: ", func_82(bParam1, 0), " To new attach point: ", func_77(iParam2, 0));
	Var1 = { func_71(bParam0, func_70(0), bParam1, 0) };
	Var5.f_9 = -1591664384;
	if (!INVENTORY::_0x025A1B1FB03FBF61(2, &Var1, &Var5, 22, 1))
	{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 162, "[WEAPON_LOCKER][WEAPON_MOVE_TO_PLAYER] - no weapon at attach point: ", func_77(iParam2, 0));
	}
	DEBUG::_0xA308F935BDECCEC0(8, 162, "[WEAPON_LOCKER][WEAPON_MOVE_TO_PLAYER] ----------------------------------------------------------------");
	bVar54 = false;
	if (func_90(Var28.f_4))
	{
		Var59.f_9 = -1591664384;
		iVar83 = func_115(bParam0);
		...
		while (iVar84 < iVar83)
		{
			...
			else if (!func_116(bParam0, iVar84, &iVar82))
			{
			...
			{
				DEBUG::_0xA308F935BDECCEC0(648, 162, "[WEAPON_LOCKER][WEAPON_MOVE_TO_PLAYER][MOVE_TO_EMPTY] Index: ", iVar84, " AttachPoint: ", func_77(iVar82, 0));
				if (iParam2 != iVar82)
				{
					DEBUG::_0xA308F935BDECCEC0(680, 162, "[WEAPON_LOCKER][WEAPON_MOVE_TO_PLAYER][MOVE_TO_EMPTY] not the right attach point: ", func_77(iVar82, 0), " looking for: ", func_77(iParam2, 0));
				}
				else if (!func_116(bParam0, iVar84 + 1, &iVar81))
				{
				...
				else if (!func_118(iVar81))
				{
					DEBUG::_0xA308F935BDECCEC0(168, 162, "[WEAPON_LOCKER][WEAPON_MOVE_TO_PLAYER][MOVE_TO_EMPTY] Failed - attach point: ", func_77(iVar81, 0), " can not be used, locked");
				}
				else
				{
					if (WEAPON::_GET_PED_WEAPON_INVENTORY_UID(Global_33, iVar81, &uVar55))
					{
						DEBUG::_0xA308F935BDECCEC0(648, 162, "[WEAPON_LOCKER][WEAPON_MOVE_TO_PLAYER][MOVE_TO_EMPTY] grabbed Guid at attach index: ", iVar84 + 1, " Location: ", func_95(func_93(&uVar55), 0));
						if (INVENTORY::_0x025A1B1FB03FBF61(2, &uVar55, &Var59, 22, 1))
						{
							...
							else
							{
								...
								Jump @738; //curOff = 668
								Jump @692; //curOff = 671
								DEBUG::_0xA308F935BDECCEC0(40, 162, "[WEAPON_LOCKER][WEAPON_MOVE_TO_PLAYER][MOVE_TO_EMPTY] - No weapon equipped at attach point: ", func_77(iVar81, 0));
								if (func_119(&Var28, &iVar81, 1))
								{
								...
								if (!bVar54)
								{
									if (func_72(&uVar50))
									{
										if (func_121(bParam0, iVar27, iVar0))
										{
											if (func_119(&Var28, &iVar0, 1))
											{
										...
										{
											DEBUG::_0xA308F935BDECCEC0(43688, 162, "[WEAPON_LOCKER][WEAPON_MOVE_TO_PLAYER][SWAP] - _eWeapon: ", func_76(bParam0), " DestPoint: ", func_77(iVar27, 0), " NewPoint: ", func_77(iVar0, 0), " Should not swap!");
										}
									}
									else
									{
										DEBUG::_0xA308F935BDECCEC0(40, 162, "[WEAPON_LOCKER][WEAPON_MOVE_TO_PLAYER][SWAP] - No weapon is stored at AttachPoint: ", func_77(iParam2, 0));
									}
								}
								else
								{
...
bool func_83(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(174248, 162, "[WEAPON_LOCKER][MOVE_WEAPON_LOCKER] - Weapon: ", func_76(Var0.f_4), " AttachPoint(", Var0.f_14, "): ", func_77(Var0.f_14, 0), " moved. Current Location: ", func_95(func_93(&Var0), 0));
	return true;
}
...
bool func_84(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(10920, 162, "[WEAPON_LOCKER][MOVE_WEAPON_HORSE] - Weapon: ", func_76(Var0.f_4), " AttachPoint: ", func_77(Var0.f_14, 0), " moved. Current Location: ", func_95(func_93(&Var0), 0));
	return true;
}
...
bool func_89(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (iParam2 < 0)
	{
...
bool func_90(bool bParam0)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(168, 162, "[WEAPON_LOCKER][WEAPON_VALID] - eWeapon: ", func_76(bParam0), " not a weapon.");
		return false;
	}
	if (!WEAPON::_0x705BE297EEBDB95D(bParam0) && !WEAPON::_IS_WEAPON_BOW(bParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(2216, 162, "[WEAPON_LOCKER][WEAPON_VALID] - eWeapon: ", func_76(bParam0), " invalid weapon. IS_WEAPON_A_GUN? ", WEAPON::_0x705BE297EEBDB95D(bParam0), " IS_WEAPON_BOW? ", WEAPON::_IS_WEAPON_BOW(bParam0));
		return false;
	}
	return true;
}
...
bool func_96(int* iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	struct<13> Var0;
	bool bVar53;
	var uVar54;
	...
	if (!func_90(bParam2))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 162, "[WEAPON_LOCKER][WEAPON_LIST_ADD_ITEM] - ERROR! Not a valid weapon, Name: ", func_76(bParam2));
		return false;
	}
	Var0 = 1;
	Var0.f_1 = 1;
	...
	Var0.f_11 = -1;
	Var0.f_12 = -1;
	if (!func_124(bParam2, bParam3, &Var0, iParam4, iParam5))
	{
	...
	if (bVar53)
	{
		...
		{
			DEBUG::_0xA308F935BDECCEC0(648, 162, "[WEAPON_LOCKER][WEAPON_LIST] iIndex: ", bParam1, " failed to add weapon to list.. Name: ", func_76(bParam2));
			return false;
		}
	}
	return true;
...
struct<4> func_110(bool bParam0)
{
	int iVar0;
	...
	if (Global_1572887.f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				Global_1272425 = { func_71(joaat("CHARACTER"), func_128(), -1591664384, bParam0) };
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1272425.f_12 = { func_71(joaat("CHARACTER"), func_128(), -1591664384, 0) };
	...
	return func_71(joaat("CHARACTER"), func_128(), -1591664384, bParam0);
}
...
bool func_116(bool bParam0, int iParam1, var uParam2)
{
	if (!func_75(bParam0, 0))
	{
...
bool func_119(int iParam0, int iParam1, bool bParam2)
{
	...
	DEBUG::_0xA308F935BDECCEC0(2728, 162, "[WEAPON_LOCKER][WL_GIVE_WEAPON_TO_PED] - Request to give weapon: ", func_76(Var0.f_4), " New Slot: ", func_77(*iParam1, 0), " bTickerMessage: ", bParam2);
	Var0.f_21 = 1;
	if (!INVENTORY::_0xD80A8854DB5CFBA5(2, iParam0, &Var0, 22))
	{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(43688, 162, "[WEAPON_LOCKER][WL_GIVE_WEAPON_TO_PED] Weapon: ", func_76(Var22.f_4), " moving from point: ", func_77(Var0.f_14, 0), " to ", func_77(Var22.f_6, 0), " SUCCESS!");
	}
	else
	{
	...
	if (bParam2)
	{
		if (func_131(Var22.f_6, &iVar44))
		{
			StringCopy(&cVar45, func_76(Var22.f_4), 64);
		...
		{
			DEBUG::_0x83407B92D46F25C3(40, 162, "[WEAPON_LOCKER][WL_GIVE_WEAPON_TO_PED] - Failed to get AttachPoint label for: ", func_77(Var22.f_6, 0));
		}
	}
	return true;
}
...
bool func_124(bool bParam0, bool bParam1, var uParam2, int iParam3, int iParam4)
{
	struct<5> Var0;
	...
	StringCopy(&(uParam2->f_16), func_76(bParam0), 64);
	...
	uParam2->f_8 = 0;
	uParam2->f_9 = 0;
	if (!func_135(bParam0, bParam1, uParam2))
	{
...
bool func_130()
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(8, 162, "[WEAPON_LOCKER][CAN_OFF_HAND_HOLSTER_BE_USED] SHORTARM_WEAPONS_COUNT : ", func_140());
	if (!func_141())
	{
		return false;
	}
...
bool func_134(bool bParam0, var uParam1)
{
	...
	if (!func_142(bParam0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 162, "[WEAPON_LOCKER][_UI_WIDGET_WEAPON_STATS_FILL_DATA] - ERROR! - Item is not a weapon: ", func_76(bParam0));
		return false;
	}
	Var0.f_1 = 20;
	if (!ITEMDATABASE::_ITEM_DATABASE_FILLOUT_ITEM_EFFECTS_IDS(bParam0, &Var0))
	{
		DEBUG::_0x83407B92D46F25C3(40, 162, "[WEAPON_LOCKER][_UI_WIDGET_WEAPON_STATS_FILL_DATA] - ERROR! - Was not able to fillout item effects for weapon: ", func_76(bParam0));
		return false;
	}
	if (Var0 <= 0)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 162, "[WEAPON_LOCKER][_UI_WIDGET_WEAPON_STATS_FILL_DATA] - num effects for weapon: ", func_76(bParam0), " is <= 0");
		return false;
	}
	fVar34 = 100f;
	...
	iVar39 = 0;
	iVar40 = 0;
	Var41 = { func_144(bParam0, 0, 0) };
	Var46 = { func_71(bParam0, Var41, Var41.f_4, 0) };
			...
			if (func_75(bVar53, 0))
			{
				...
				if (ITEMDATABASE::_ITEM_DATABASE_FILLOUT_ITEM_EFFECTS_IDS(bVar53, &Var0))
				{
					...
					while (iVar37 < Var0)
					{
						if (!ITEMDATABASE::_ITEM_DATABASE_FILLOUT_ITEM_EFFECTS_ID_INFO(Var0.f_1[iVar37], &vVar22))
						{
							DEBUG::_0xA308F935BDECCEC0(648, 162, "[WEAPON_LOCKER][_UI_WIDGET_WEAPON_STATS_FILL_DATA] Failed to fillout weapon mod effect at index: ", iVar37, " eEquippedModNAME: ", func_76(bVar53));
						}
...
bool func_135(bool bParam0, bool bParam1, var uParam2)
{
	struct<4> Var0;
	int iVar4;
	int iVar5;
	...
	DEBUG::_0xA308F935BDECCEC0(40, 162, "[WEAPON_LOCKER][WLBOW] SET_PROMPTS - for item/weapon: ", func_76(bParam0));
	if (!func_90(bParam0))
	{
		DEBUG::_0x83407B92D46F25C3(8, 162, "[WEAPON_LOCKER][WLBOW] SET_PROMPTS - ERROR! not a valid weapon item.");
		return false;
	}
	Var0 = { func_71(bParam0, func_70(0), bParam1, 0) };
	if (!func_72(&Var0))
	{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 162, "[WEAPON_LOCKER][WLBOW] SET_PROMPTS - SLOTID_WEAPON_0 player does not own weapon: ", func_76(bParam0));
		if (!func_148(bParam0, -649335959 /* GXTEntry: "Left" */, 1))
		{
			DEBUG::_0x83407B92D46F25C3(40, 162, "[WEAPON_LOCKER][WLBOW] SET_PROMPTS - ERROR! SLOTID_WEAPON_1 Unable to properly setup prompts, player does not own weapon: ", func_76(bParam0));
			return false;
		}
	}
	...
	while (iVar6 < iVar5)
	{
		if (!func_116(bParam0, iVar6, &iVar4))
		{
		}
		else
		{
			DEBUG::_0xA308F935BDECCEC0(648, 162, "[WEAPON_LOCKER] SET_PROMPTS - LOOP index: ", iVar6, " AttachPoint: ", func_77(iVar4, 0));
			if (iVar6 == 0)
			{
				uParam2->f_36 = func_118(iVar4);
				uParam2->f_35 = func_149(&Var0, iVar4) == 0;
			...
			{
				uParam2->f_40 = func_118(iVar4);
				uParam2->f_39 = func_149(&Var0, iVar4) == 0;
...
int func_140()
{
	...
	if (func_87("ALL WEAPONS", &iVar0, &iVar1, -1591664384, 0))
	{
		...
		while (bVar2 < iVar1)
		{
			if (!func_89(&Var4, bVar2, iVar0, iVar1))
			{
			}
...
bool func_141()
{
	return (func_139(joaat("UPGRADE_OFFHAND_HOLSTER"), 0, 0, 0) > 0 && func_147(func_71(joaat("WARDROBE"), func_110(1), 1034665895, 1), -234132662, 1, -1) != 0);
}
...
struct<5> func_144(bool bParam0, bool bParam1, bool bParam2)
{
	struct<5> Var0;
	int iVar5;
	struct<10> Var6;
...
{
	return func_167(&uParam0, bParam4, bParam5, iParam6);
}
...
bool func_148(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_168(bParam0, &uVar22, &Var0, bParam1))
	{
		return false;
	}
	if (!bParam2)
...
int func_149(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0xA308F935BDECCEC0(40, 162, "[WEAPON_LOCKER][CAN_MOVE_WEAPON_TO_PLAYER] - Failed to get weapon at attachPoint: ", func_77(iParam1, 0));
	}
	if (func_93(iParam0) == 0)
	{
		DEBUG::_0xA308F935BDECCEC0(168, 162, "[WEAPON_LOCKER][CAN_MOVE_WEAPON_TO_PLAYER] - Weapon: ", func_76(Var0.f_4), " already on player.");
		if (func_72(&uVar22))
		{
			if (func_169(iParam0, &uVar22))
			{
				DEBUG::_0xA308F935BDECCEC0(168, 162, "[WEAPON_LOCKER][CAN_MOVE_WEAPON_TO_PLAYER] - Query weapon and current weapon at AttachPoint: ", func_77(iParam1, 0), " are the same.");
				return 3;
			}
		}
...
{
	return func_172(bParam0, *uParam1, iParam2, iParam3, 1, bParam4) > 0;
}
...
bool func_162(bool bParam0, int iParam1, bool bParam2)
{
	...
	if (func_168(bParam0, &uVar0, iParam1, bParam2))
	{
...
struct<4> func_163(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		if (!INVENTORY::_0xB881CA836CC4B6D4(&(Global_1272425.f_8)))
		{
			...
			Global_1272425.f_8 = { func_71(271701509, func_110(bParam0), 12999093, 0) };
		}
		return Global_1272425.f_8;
	}
	return func_71(271701509, func_110(bParam0), 12999093, 0);
}
...
int func_167(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	struct<10> Var0;
...
bool func_168(bool bParam0, int iParam1, int iParam2, bool bParam3)
{
	int iVar0;

	iVar0 = func_94(0);
	*iParam1 = { func_71(bParam0, func_70(0), bParam3, 0) };
...
int func_170(int iParam0)
{
	...
	if (WEAPON::_IS_WEAPON_ONE_HANDED(Var0.f_4))
	{
		if (iVar22 == 2)
		{
			DEBUG::_0xA308F935BDECCEC0(168, 162, "[WEAPON_LOCKER][CAN_PLAYER_WEAPON_BE_REMOVED] - Weapon: ", func_76(Var0.f_4), " can not be removed, from primary slot.");
			return 3;
		}
	}
...
int func_172(bool bParam0, struct<4> Param1, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	int iVar0;
	struct<4> Var1;
	...
	if (!bParam7 && func_176(bParam0, joaat("DEFAULT")) == 0)
	{
...
bool func_174(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
...
bool func_175(int iParam0, bool bParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	if (!func_174(&uVar0, iParam2, bParam3, 0, iParam4))
	{
