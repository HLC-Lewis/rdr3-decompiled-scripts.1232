...
void func_15(var uParam0)
{
	...
	WEAPON::_0x94A3C1B804D291EC(Global_33, 0, 0, 1, 1);
	...
	ANIMSCENE::SET_ANIM_SCENE_ENTITY(uParam0->f_42, &cVar0, Global_33, 0);
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_4))
	{
...
{
	DEBUG::_0x1B08D1EB9D8C4931(8, 157, "PROCESS_GENERIC_ITEM_CLEANUP: Running Generic Item Cleanup for entity - Animal Pheromone.");
	if (uParam0->f_6)
	{
		if (uParam0->f_40 < 1)
		{
	...
	{
		DEBUG::_0x1B08D1EB9D8C4931(8, 157, "PROCESS_GENERIC_ITEM_CLEANUP: Forcing detach of entity - Animal Pheromone.");
		ENTITY::DETACH_ENTITY(uParam0->f_4, true, true);
		uParam0->f_9 = 1;
	}
	return true;
...
bool func_35(bool bParam0, int iParam1)
{
	...
	if (func_63(bParam0, 1399091007))
	{
		func_64(bParam0, &uVar1, &uVar2);
		return uVar2;
	}
...
void func_36(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (!func_65() || bParam6)
	{
		func_66(bParam0, iParam1, bParam2, bParam4, bParam3, bParam5);
		return;
	}
	bVar0 = false;
	iVar1 = MISC::ABSI(iParam1);
	StringCopy(&cVar2, func_67(iVar1 == 1, "ITEM_GET_PUMP", "ITEM_GET_PUMP_MULT"), 32);
	...
	else if (bParam2 && func_68(bParam0, 2097152))
	{
	...
	if ((((((((iVar6 == joaat("AMMO") && bParam0 != joaat("AMMO_HATCHET")) && bParam0 != joaat("AMMO_HATCHET_CLEAVER")) && bParam0 != joaat("AMMO_HATCHET_HUNTER")) && bParam0 != joaat("AMMO_TOMAHAWK_ANCIENT")) && bParam0 != joaat("AMMO_POISONBOTTLE")) && bParam0 != joaat("AMMO_MOONSHINEJUG_MP")) && !func_63(bParam0, -1982291600)) && !func_63(bParam0, 137764179))
	{
		iVar10 = joaat("AMMO_TYPES");
		iVar11 = joaat("AMMO_TYPES");
	}
	iVar12 = func_55(bParam0);
	...
	else if (!func_69(bParam0, &Var7, iVar11, iVar10, 0, joaat("UI_ITEMVIEWER")))
	{
		Var7 = "_PLACEHOLDER";
	...
	if (func_63(bParam0, 474910316))
	{
		sVar17 = func_70(bParam0);
	...
	bVar18 = func_72(bParam0, 0);
	if ((func_73(iVar12) && func_63(bParam0, -306684263)) && bVar18 != 0)
	{
		bVar18 = func_74(bParam0);
	}
	else if (func_24(bParam0) == joaat("CLOTHING"))
	{
		bVar19 = func_75(bParam0);
		if (func_23(bVar19, 0))
		{
			bVar18 = func_72(bVar19, 0);
		}
	...
	if (func_76(bParam0, 1443104131) && bParam3)
	{
		iVar20 = 1;
		func_77(bParam0, -915411861, &iVar20, 0);
	...
	sVar21 = func_78(MISC::_CREATE_VAR_STRING(10, &cVar2, MISC::_CREATE_VAR_STRING(0, bVar18), iVar1), iVar13);
	if (iParam1 == 1)
	{
	...
	{
		sVar21 = MISC::_CREATE_VAR_STRING(0, func_79(bParam0, -442898163));
	}
	if (iVar12 == -126813555 || iVar12 == 1946043663)
	{
		StringCopy(&cVar22, "", 128);
		if (func_80(bParam0, &cVar22))
		{
			sVar21 = func_82(func_81(cVar22), joaat("COLOR_PURE_WHITE"));
		}
	}
	DEBUG::_0xF0783374333FD8CE(174760, 158, "ADD_QUEUED_ITEM_DISPLAY: Adding - ", func_33(bParam0, 0), " with color ", func_83(iVar13, 0), " sound ", sVar14, " set ", sVar15);
	func_84(sVar21, Var7.f_1, MISC::GET_HASH_KEY(Var7), iVar16, iVar13, sVar15, sVar14, 0, 1);
}
...
struct<2> func_37(bool bParam0)
{
	...
	if (func_63(bParam0, -305066475))
	{
		if (func_85() == -1)
		{
			if (func_63(bParam0, -537818634))
			{
				return func_86(joaat("MEDICINE_AND_DEADEYE_ITEMS"));
			}
			else
			{
				return func_86(joaat("DEADEYE_ITEMS"));
			}
		}
	}
	else if (func_63(bParam0, -537818634))
	{
		return func_86(joaat("MEDICINE_ITEMS"));
	}
	if (func_63(bParam0, 2084895747))
	{
		return func_86(joaat("LOCK_BREAKER_ITEMS"));
	}
	return Var2;
}
...
bool func_38(bool bParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	DEBUG::_0xF0783374333FD8CE(166056, 157, "REMOVE_WEAPON_FROM_PLAYER_INVENTORY - ", func_33(bParam0, 0), ", iAmountToRemove = ", iParam1, ", bCarriedOnly = ", bParam2, ", removeReason = ", func_87(iParam3, 0));
	Var0 = { func_88(bParam0, -1591664384, -1591664384, -1591664384, 0, 0, 0) };
	if (bParam2)
	{
		func_90(&Var0, func_89(0));
	}
	if (!func_91(&Var0, &iVar14, &iVar15, 0))
	{
	...
	while (iVar35 < iVar15)
	{
		...
		{
			if (!func_52(&Var16, iVar35, iVar14, iVar15))
			{
			}
			else
			{
				Var30.f_4 = Var16.f_9;
				Var30 = { Var16.f_5 };
				if (func_92(bParam0, &Var16, &Var30, 1, iParam3, 0, 0))
				{
					iVar36++;
				}
			}
...
bool func_39(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = func_60(bParam0, joaat("DEFAULT"));
	if (iVar0 != 0)
	{
		return func_93(bParam0, iParam1, iParam2, bParam3, bParam4);
	}
	Var1 = { func_40(bParam0, bParam4, 0) };
	Var6 = { func_94(bParam0, Var1, Var1.f_4, bParam4) };
	return func_92(bParam0, &Var6, &Var1, iParam1, iParam2, bParam3, bParam4);
}
...
struct<5> func_40(bool bParam0, bool bParam1, bool bParam2)
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 157, "PLAYER_INVENTORY_GET_DEFAULT_ITEM_SLOT_INFO - eInvItemGroup = ", func_96(iVar5, 0));
	switch (iVar5)
	{
		case joaat("CLOTHING"):
			Var0 = { func_94(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
			Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, joaat("WARDROBE"));
			break;
		case joaat("WEAPON"):
			Var0 = { func_89(bParam1) };
			if (bParam2 && func_97(bParam0, 1))
			{
				Var6.f_9 = -1591664384;
				if (!func_98(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_98(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_99(bParam0, &Var6, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
		case joaat("DOG"):
			if (func_101(bParam0, -1823706425))
			{
				Var0 = { func_94(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, joaat("KIT_CAMP"));
			}
			else if (func_101(bParam0, -1483207246))
			{
				Var0 = { func_94(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, joaat("WARDROBE"));
			}
			...
			else if (func_101(bParam0, -1653629781))
			{
				Var0 = { func_94(1384535894, Var0, 1784584921, bParam1) };
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(bParam0, -833319691))
			{
				...
				if (!func_102(Var0, &Var28, bParam1, 0, -1))
				{
	...
	DEBUG::_0xA308F935BDECCEC0(10920, 157, "PLAYER_INVENTORY_GET_DEFAULT_ITEM_SLOT_INFO - ", func_33(bParam0, 0), ": ", func_103(Var0.f_4, 0), " - ", UNK_0xD2E4270E5D98EEE4(&Var0));
	return Var0;
}
...
bool func_41(bool bParam0)
{
	...
	return INVENTORY::_INVENTORY_ARE_LOCAL_CHANGES_ALLOWED(func_61(bParam0));
}
...
bool func_43(var uParam0)
{
	...
	if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(uParam0->f_42))
	{
		...
		if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(uParam0->f_42, false) && func_107(uParam0->f_42))
		{
			return true;
		}
	}
...
void func_44(bool bParam0)
{
	...
	Var0.f_1 = 20;
	if ((func_63(bParam0, 1573112293) || func_63(bParam0, 672467738)) || func_63(bParam0, -550842268))
	{
		bVar37 = true;
	}
	DEBUG::_0x4DC69742196F818A(40, 158, "PROCESS_GENERIC_ITEM_USE - Inventory Item Group - ", func_96(func_24(bParam0), 0));
	if (func_24(bParam0) == joaat("CONSUMABLE"))
	{
		...
		while (iVar29 < Var0)
		{
			DEBUG::_0xF0783374333FD8CE(648, 158, "PROCESS_GENERIC_ITEM_USE - Effect ", iVar29, ":", func_108(Var0.f_1[iVar29], 0));
			if (!ITEMDATABASE::_ITEM_DATABASE_FILLOUT_ITEM_EFFECTS_ID_INFO(Var0.f_1[iVar29], &Var22))
			{
				DEBUG::_0x9A6C65DDDBEC9C52(2696, 158, "PROCESS_GENERIC_ITEM_USE - Effect ", iVar29, ":", func_108(Var0.f_1[iVar29], 0), " failed to Fillout via ITEMDATABASE_FILLOUT_EFFECT_ID_INFO.");
			}
			else
			{
				DEBUG::_0xF0783374333FD8CE(25725608, 158, "PROCESS_GENERIC_ITEM_USE - Key ", func_108(Var22, 0), " Enum ID ", func_109(Var22.f_1, 0), " Value ", Var22.f_2, " Time ", Var22.f_3, " unit ", Var22.f_4, " percent ", Var22.f_5);
				if (-943921969 == Var22.f_1)
				{
					fVar30 = func_110(0, Var22.f_2);
					func_111(Var22.f_2);
					bVar39 = true;
				}
				else if (-1104847406 == Var22.f_1)
				{
					fVar31 = func_110(2, Var22.f_2);
					func_112(Var22.f_2, 0);
					bVar38 = true;
				}
				else if (381158954 == Var22.f_1)
				{
					fVar32 = func_110(1, Var22.f_2);
					func_113(Var22.f_2);
				}
				else if (-416929031 == Var22.f_1)
				{
					fVar33 = func_114(BUILTIN::TO_FLOAT(Var22.f_2), Var22.f_5);
					func_115(0, fVar33, 1, 1, bVar37);
					bVar39 = true;
				}
				else if (1857353317 == Var22.f_1)
				{
					fVar34 = func_114(BUILTIN::TO_FLOAT(Var22.f_2), Var22.f_5);
					func_115(2, fVar34, 1, 1, bVar37);
					bVar38 = true;
				}
				else if (1681823811 == Var22.f_1)
				{
					fVar35 = func_114(BUILTIN::TO_FLOAT(Var22.f_2), Var22.f_5);
					func_115(1, fVar35, 1, 1, bVar37);
				}
				else if (2062242710 == Var22.f_1)
				{
					fVar36 = func_116(BUILTIN::TO_FLOAT(Var22.f_3), Var22.f_4);
					func_117(19, fVar36, 1, 1);
					bVar39 = true;
				}
				else if (-826379728 == Var22.f_1)
				{
					fVar36 = func_116(BUILTIN::TO_FLOAT(Var22.f_3), Var22.f_4);
					func_117(20, fVar36, 1, 1);
					bVar38 = true;
				}
				else if (-1191740624 == Var22.f_1)
				{
					fVar36 = func_116(BUILTIN::TO_FLOAT(Var22.f_3), Var22.f_4);
					func_117(18, fVar36, 1, 1);
				}
				else if (1869697234 == Var22.f_1)
				{
					fVar36 = func_116(BUILTIN::TO_FLOAT(Var22.f_3), Var22.f_4);
					func_117(0, fVar36, 1, 1);
					bVar39 = true;
				}
				else if (1342237631 == Var22.f_1)
				{
					fVar36 = func_116(BUILTIN::TO_FLOAT(Var22.f_3), Var22.f_4);
					func_117(2, fVar36, 1, 1);
					bVar38 = true;
				}
				else if (-1240225157 == Var22.f_1)
				{
					fVar36 = func_116(BUILTIN::TO_FLOAT(Var22.f_3), Var22.f_4);
					func_117(1, fVar36, 1, 1);
				}
				else if (-816334026 == Var22.f_1)
				{
					func_118(BUILTIN::TO_FLOAT(Var22.f_2), 1);
				}
			}
			iVar29++;
		}
		if (bVar39 || func_63(bParam0, -537818634))
		{
			func_119(func_86(joaat("MEDICINE_ITEMS_USED")), 1);
		}
		if (func_63(bParam0, -1457797660))
		{
			func_119(func_86(joaat("PROVISION_ITEMS_USED")), 1);
		}
		if (bVar38)
		{
			func_119(func_86(joaat("DEADEYE_ITEMS_USED")), 1);
		}
		switch (bParam0)
		{
...
{
	DEBUG::_0xF0783374333FD8CE(8, 157, "PROCESS_GENERIC_ITEM_USE_CUSTOM: Used pheromone vial");
	Global_1198516 = 0;
	func_120(1, 0);
}
...
void func_50(int iParam0, bool bParam1)
{
	...
	if (!func_124(iParam0, iVar0, iVar1, bParam1))
	{
		return;
	}
	func_125(iVar0, iVar1);
	DEBUG::_0xA308F935BDECCEC0(10376, 105, "TUTORIAL_MARK_RUN() - Tutorial with Set: ", iVar0, " & Flag", iVar1, " marked to run. ", func_126(iParam0));
...
bool func_51(char* sParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	*iParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_61(bParam4), sParam0, bParam3, iParam2);
	if (*iParam1 >= 0)
	{
		DEBUG::_0xA308F935BDECCEC0(174216, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION - Created collection '", *iParam1, "' with size ", *iParam2, " from predicate '", sParam0, "' with ", func_103(bParam3, 0));
...
int func_57(var uParam0, int iParam1)
{
	...
	DEBUG::_0x9A6C65DDDBEC9C52(40, 208, "[METAPED_SAVE__OVERLAY_FIND_LAYER_BY_TYPE] Failed to find: ", func_127(iParam1, 0));
	return -1;
}
...
char[] func_59(bool bParam0, bool bParam1)
{
	...
	if (!func_91(&Var0, &iVar14, &cVar15, 0))
	{
...
int func_60(bool bParam0, int iParam1)
{
	...
	if (func_129(func_128(bParam0), 2))
	{
...
struct<4> func_62(bool bParam0, bool bParam1)
{
	...
	return func_94(bParam0, Var0, Var0.f_4, bParam1);
}
...
bool func_63(bool bParam0, bool bParam1)
{
	if (!func_23(bParam0, 0))
	{
		return func_130(func_128(bParam0), bParam1);
	}
	if (bParam1 == 0)
	{
		return false;
	...
	{
		DEBUG::_0x4DC69742196F818A(2728, 158, "[ITEM_HAS_PROPERTY_TAG] Found tag ", func_122(bParam1, 0), " for item ", func_33(bParam0, 0), ", returning TRUE");
		return true;
	}
	return false;
}

void func_64(bool bParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (bParam0)
...
void func_66(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
char* func_67(bool bParam0, char* sParam1, char* sParam2)
{
	if (bParam0)
	{
		return sParam1;
...
bool func_69(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 158, "FIND_INVENTORY_ITEM_TEXTURE_UI_DATA - eTextureType = ", func_131(iParam2, 0));
	...
	if (ITEMDATABASE::_ITEM_DATABASE_FILLOUT_UI_DATA(bParam0, &Var3))
	{
		...
		while (iVar0 < 5)
		{
			...
			else
			{
				...
				{
					DEBUG::_0x1B08D1EB9D8C4931(40, 158, "FIND_INVENTORY_ITEM_TEXTURE_UI_DATA: Skipping entry with type: ", func_131(Var3.f_2[iVar0 /*3*/].f_2, 0));
					Jump @476; //curOff = 261
				}
				...
				else
				{
					...
					DEBUG::_0x1B08D1EB9D8C4931(40, 158, "FIND_INVENTORY_ITEM_TEXTURE_UI_DATA:    Type: ", func_131(Var3.f_2[iVar0 /*3*/].f_2, 0));
	...
	DEBUG::_0x9A6C65DDDBEC9C52(680, 158, "FIND_INVENTORY_ITEM_TEXTURE_UI_DATA: Unable to find texture of type ", func_131(iParam2, 0), " for item ", func_33(bParam0, 0));
	return false;
}

char* func_70(bool bParam0)
{
	if (func_63(bParam0, -1995062316))
	{
		return "collectible_arrowheads";
	}
	if (func_63(bParam0, 1239889275))
	{
		return "collectible_liquor_bottles";
	}
	if (func_63(bParam0, 143267379))
	{
		return "collectible_coins";
	}
	if (func_63(bParam0, -944041124))
	{
		return "colectible_heirlooms";
	}
	if (func_63(bParam0, 1562621600))
	{
		return "collectible_jewelry";
	}
	if (func_63(bParam0, -149719013))
	{
		return "collectible_bird_eggs";
	}
	if (func_63(bParam0, 1940829793))
	{
		return "collectible_tarot_cards";
	}
	if (func_63(bParam0, 781094263))
	{
		return "collectible_flowers";
	}
	if (((func_63(bParam0, -352095726) || func_63(bParam0, -2014783736)) || func_63(bParam0, -545064757)) || func_63(bParam0, 679186220))
	{
...
{
	if (func_63(bParam0, -189374246))
	{
		if (((func_132(bParam0, -1305775593) || func_132(bParam0, 1384151091)) || func_132(bParam0, 2075388272)) || func_132(bParam0, -1738780413))
		{
			return true;
		}
	}
	if (func_63(bParam0, -753854379) || func_63(bParam0, 173360570))
	{
		return true;
	}
	return false;
...
bool func_72(bool bParam0, bool bParam1)
{
	...
	iVar0 = func_133(bParam0, bParam1);
	if (iVar0 != 0)
	{
		return iVar0;
	}
...
bool func_75(bool bParam0)
{
	...
	Var1 = { func_135(-1591664384, -1591664384, 0, 0, 0, 0, -1, iVar0, 0) };
	if (func_136(Var1, &iVar11, &iVar12, 0))
	{
		iVar13 = 0;
		while (iVar13 < iVar12)
		{
			if (ITEMDATABASE::_0x8750F69A720C2E41(iVar11, iVar13, &bVar14) && func_137(bVar14))
			{
				func_138(iVar11);
				return bVar14;
			}
...
bool func_76(bool bParam0, bool bParam1)
{
	...
	{
		DEBUG::_0x4DC69742196F818A(2728, 158, "[ITEM_HAS_INTERACTION_TAG] Found tag ", func_122(bParam1, 0), " for item ", func_33(bParam0, 0), ", returning TRUE");
		return true;
	}
	return false;
}
...
int func_77(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	if (!func_23(bParam0, 0) && !func_129(func_128(bParam0), 2))
	{
	...
	if (!ITEMDATABASE::_ITEM_DATABASE_FILLOUT_ACQUIRE_COST(bParam0, bParam1, &Var0))
	{
		if (!bParam3)
		{
			DEBUG::_0xA308F935BDECCEC0(680, 158, "GET_ITEM_ACQUIRE_COST_OUTPUT_QUANTITY - Unable to find cost ", func_139(bParam1, 0), " for item ", func_33(bParam0, 0));
		}
		return 0;
	}
	if (!bParam3)
	{
		DEBUG::_0x4DC69742196F818A(168, 158, "GET_ITEM_ACQUIRE_COST_OUTPUT_QUANTITY - Found requested identifier of ", func_139(bParam1, 0), " with output quantity ", Var0.f_1);
	}
	*iParam2 = Var0.f_1;
	return 1;
}
...
bool func_79(bool bParam0, int iParam1)
{
	...
	bVar0 = func_140(bParam0, iParam1);
	if (bVar0 == 0)
	{
...
bool func_80(bool bParam0, char* sParam1)
{
	int iVar0;
	char cVar1[128];
	...
	StringCopy(sParam1, func_141(bParam0), 128);
	...
	StringCopy(&cVar1, func_143(bParam0), 128);
...
char* func_81(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)
{
	return HUD::_0xD8402B858F4DDD88(&cParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&cParam0));
}

char* func_82(char* sParam0, int iParam1)
{
	if (iParam1 == joaat("COLOR_PURE_WHITE"))
	{
		return MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0);
	}
	return func_78(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
var func_84(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, int iParam8)
{
	struct<4> Var0;
	struct<7> Var13;
	var uVar20;
...
struct<14> func_88(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6)
{
	struct<14> Var0;
	...
	{
		Var0.f_1 = bParam1;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eSlot:     ", func_103(bParam1, 0));
	}
	if (bParam2 != 0 && bParam2 != -1591664384)
	{
		Var0.f_2 = bParam2;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eFitsSlot: ", func_103(bParam2, 0));
	}
	if (bParam3 != 0 && bParam3 != -1591664384)
	{
		Var0.f_3 = bParam3;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eHasSlot:  ", func_103(bParam3, 0));
	}
	if (bParam4 != 0)
	{
		Var0.f_4 = bParam4;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eCategory: ", func_145(bParam4, 0));
	}
	if (bParam5 != 0)
	{
		Var0.f_5 = bParam5;
	...
	{
		Var0.f_8 = iParam6;
		DEBUG::_0xA308F935BDECCEC0(40, 157, "PLAYER_INVENTORY_CREATE_ITEM_COLLECTION_FILTER - eItemGroup:  ", func_96(iParam6, 0));
	}
	return Var0;
}
...
struct<4> func_89(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		if (!INVENTORY::_0xB881CA836CC4B6D4(&(Global_1272425.f_4)))
		{
			...
			Global_1272425.f_4 = { func_94(923904168, func_95(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		if (!INVENTORY::_0xB881CA836CC4B6D4(&(Global_1272425.f_16)))
		{
			...
			Global_1272425.f_16 = { func_94(923904168, func_95(bParam0), -740156546, 0) };
		}
		return Global_1272425.f_16;
	}
	return func_94(923904168, func_95(bParam0), -740156546, 0);
}

void func_90(var uParam0, struct<4> Param1)
{
...
bool func_91(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
...
bool func_92(bool bParam0, int iParam1, var uParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	struct<14> Var0;
	int iVar14;
	struct<13> Var15;
	...
	Var0.f_9 = -1591664384;
	if (!func_102(*iParam1, &Var0, bParam6, 0, -1))
	{
	...
	if (!func_41(bParam6))
	{
		...
		else if (func_85() == 0)
		{
			...
			Var15.f_9 = iParam3;
			Var15.f_12 = iParam4;
			DEBUG::_0xF0783374333FD8CE(10888, 157, "PLAYER_INVENTORY_REMOVE_ITEM_WITH_GUID - Sending a Use transaction for ", iParam3, "x item ", func_33(bParam0, 0), " in ", func_103(uParam2->f_4, 0));
			iVar14 = func_147(joaat("USE"), &Var15, 1);
			if (iVar14 != -1)
			{
				Var32.f_7 = -142743235;
				Var32.f_16 = -1;
				Var32 = bParam5;
				Var32.f_7 = iParam4;
				func_148(iVar14, Var32);
			}
		}
		return iVar14 != -1;
	}
	DEBUG::_0x4DC69742196F818A(174728, 157, "PLAYER_INVENTORY_REMOVE_ITEM_WITH_GUID - Removing ", iParam3, "x item ", func_33(bParam0, 0), " in ", func_103(uParam2->f_4, 0), " with reason ", func_87(iParam4, 0));
	if (!INVENTORY::_0x3E4E811480B3AE79(func_61(bParam6), iParam1, iParam3, iParam4))
	{
...
int func_93(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!func_41(bParam4))
	{
		...
		if (!func_149(&Var1, &iVar62, bParam0, iVar0, iParam1, 1) || iVar62 < 1)
		{
		...
		while (iVar63 < iVar62)
		{
			Var65 = { func_150(bParam0, &(Var1[iVar63 /*6*/])) };
			Var65.f_12 = iParam2;
			iVar64 = func_147(joaat("USE"), &Var65, 1);
			if (iVar64 == -1)
			{
		...
		if (iVar64 != -1)
		{
			...
			Var82 = bParam3;
			Var82.f_7 = iParam2;
			func_148(iVar64, Var82);
			return 1;
		}
		return 0;
	}
	DEBUG::_0x4DC69742196F818A(10888, 157, "PLAYER_INVENTORY_REMOVE_ITEM_WITH_ITEMID - Removing ", iParam1, "x item ", func_33(bParam0, 0), " with reason ", func_87(iParam2, 0));
	if (!INVENTORY::_0xB4158C8C9A3B5DCE(func_61(bParam4), bParam0, iParam1, iParam2))
	{
...
struct<4> func_94(bool bParam0, var uParam1, bool bParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	struct<4> Var0;
...
struct<4> func_95(bool bParam0)
{
	...
	if (Global_1572887.f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				Global_1272425 = { func_94(joaat("CHARACTER"), func_151(), -1591664384, bParam0) };
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1272425.f_12 = { func_94(joaat("CHARACTER"), func_151(), -1591664384, 0) };
	...
	return func_94(joaat("CHARACTER"), func_151(), -1591664384, bParam0);
}
...
bool func_98(bool bParam0, var uParam1, int iParam2, int iParam3, bool bParam4)
{
	return func_153(bParam0, *uParam1, iParam2, iParam3, 1, bParam4) > 0;
}
...
bool func_99(bool bParam0, int iParam1, bool bParam2)
{
	...
	if (func_154(bParam0, &uVar0, iParam1, bParam2))
	{
...
struct<4> func_100(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		if (!INVENTORY::_0xB881CA836CC4B6D4(&(Global_1272425.f_8)))
		{
			...
			Global_1272425.f_8 = { func_94(271701509, func_95(bParam0), 12999093, 0) };
		}
		return Global_1272425.f_8;
	}
	return func_94(271701509, func_95(bParam0), 12999093, 0);
}
...
bool func_101(bool bParam0, bool bParam1)
{
	...
	while (iVar2 < iVar3)
	{
		...
		{
			if (func_155(bParam0, bParam1, bVar0))
			{
				return true;
			}
		}
...
bool func_102(var uParam0, var uParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, int iParam7)
{
	return func_156(&uParam0, iParam4, bParam5, bParam6, iParam7);
}

var func_103(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case 0:
...
bool func_104()
{
	if ((Global_1940463.f_11709 != (Global_1940463.f_41.f_203 - 1) || func_158(func_157(0), Global_1940463.f_11701, 0, 1, 1) > 0) || Global_1940463.f_11709 == 15)
	{
		return true;
	}
	func_159(0);
...
var func_109(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case 0:
...
void func_111(int iParam0)
{
	...
	func_161(BUILTIN::TO_FLOAT((iParam0 * iVar1)), 0);
	DEBUG::_0xF0783374333FD8CE(8, 84, "RPG_GLOBAL_REFILL_PLAYER_HEALTH_TANKS - Total Health Reserves # ", PED::_0x16F2C8C084AB2092(iVar0));
...
void func_112(int iParam0, bool bParam1)
{
	...
	func_163(BUILTIN::TO_FLOAT((iParam0 * iVar0)), 0, bParam1);
}
...
void func_113(int iParam0)
{
	...
	iVar1 = func_164(2);
	func_165(BUILTIN::TO_FLOAT((iParam0 * iVar1)), 0);
}
...
void func_115(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4)
{
	if (fParam1 == 0f)
	{
		return;
	...
	if (bParam4)
	{
		fParam1 = func_166(iParam0, fParam1, 1);
	}
	func_168(iParam0, (func_167(iParam0, 2) + fParam1), bParam2, bParam3, 1, 2);
}

float func_116(float fParam0, int iParam1)
{
	switch (iParam1)
	{
		case 0:
...
int func_117(int iParam0, char* sParam1, bool bParam2, bool bParam3)
{
	...
	DEBUG::_0xF0783374333FD8CE(2472, 84, "RPG_GLOBAL_SET_OVERPOWER_FOR_PLAYER_ATTRIBUTE - Attribute: ", func_169(iParam0, 0), " will be Overpowered this frame for  ", sParam1, " seconds");
	return func_170(iParam0, sParam1, bParam2, bParam3);
}

void func_118(float fParam0, bool bParam1)
{
	if (fParam0 > 10f)
	{
		fParam0 = 10f;
...
void func_120(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 82, "LA__EXTERNAL__BROADCAST_LEGENDARY_ANIMAL_PHEROMONE_VIAL_EVENT - Broadcasting network script event of type: ", func_173(iParam0, 0));
	Var0 = 195;
	...
	if (iParam0 == 2)
	{
		...
		{
			DEBUG::_0xD9911C7B5F8CD69C(168, 82, "LA__EXTERNAL__BROADCAST_LEGENDARY_ANIMAL_PHEROMONE_VIAL_EVENT - Cannot broadcast event of type: ", func_173(iParam0, 0), " without a valid animal ped!");
			return;
		}
		...
		{
			DEBUG::_0xD9911C7B5F8CD69C(2728, 82, "LA__EXTERNAL__BROADCAST_LEGENDARY_ANIMAL_PHEROMONE_VIAL_EVENT - Cannot broadcast event of type: ", func_173(iParam0, 0), ". ", UNK_0xE02C950E4C991632(iParam1), " does not belong to this script or is not networked!");
			return;
		}
		Var0.f_5 = NETWORK::PED_TO_NET(iParam1);
		DEBUG::_0xA308F935BDECCEC0(648, 82, "LA__EXTERNAL__BROADCAST_LEGENDARY_ANIMAL_PHEROMONE_VIAL_EVENT - Attaching network ID of animal (", Var0.f_5, ") to event of type: ", func_173(iParam0, 0));
	}
	uVar6 = func_174(0, 8);
...
bool func_124(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_175(iParam1, iParam2))
	{
		if (!bParam3)
		{
			DEBUG::_0xA308F935BDECCEC0(168, 105, "TUTORIAL_CAN_GO_PENDING_CHECKS - Tutorial: ", func_126(iParam0), " has already run, and is not being forced.");
			return false;
		}
	}
	if (!func_176(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 105, "TUTORIAL_CAN_GO_PENDING_CHECKS - NOT CAN_TUTORIAL_PLAY_IN_MODE ", func_177(iParam0, 0));
		return false;
	}
	if (func_178(iParam0))
	{
		DEBUG::_0xA308F935BDECCEC0(40, 105, "TUTORIAL_CAN_GO_PENDING_CHECKS - Timed tutorial is delayed or finished ", func_177(iParam0, 0));
		return false;
	}
	if ((Global_1900777.f_67 && !func_179(iParam0, 1)) || func_180(32768))
	{
		if (!func_179(iParam0, 262144) || !Global_1904703.f_8785)
		{
...
int func_130(bool bParam0, bool bParam1)
{
	...
	{
		DEBUG::_0x4DC69742196F818A(2728, 158, "[BUNDLE_HAS_PROPERTY_TAG] Found tag ", func_122(bParam1, 0), " for bundle ", func_182(bParam0, 0), ", returning TRUE");
		return 1;
	}
	return 0;
}
...
int func_132(bool bParam0, bool bParam1)
{
	...
	{
		DEBUG::_0x4DC69742196F818A(2728, 158, "[ITEM_HAS_FOLDER_TAG] Found tag ", func_122(bParam1, 0), " for item ", func_33(bParam0, 0), ", returning TRUE");
		return 1;
	}
	return 0;
}
...
struct<10> func_135(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	struct<10> Var0;
...
bool func_136(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, int iParam10, int iParam11, char* sParam12)
{
...
char* func_139(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case -2141192156:
	...
	if (ITEMDATABASE::_ITEM_DATABASE_FILLOUT_TAG_DATA(bParam0, &Var0, &iVar42, 20))
	{
		...
		while (iVar43 < iVar42)
		{
			if (Var0[iVar43 /*2*/].f_1 == iParam1)
			{
				...
				DEBUG::_0x4DC69742196F818A(10920, 158, "[INVENTORY_ITEM__HAS_TAG_OF_TYPE] Found tag type ", func_183(iParam1, 0), " for item ", func_33(bParam0, 0), ", returning tag : ", func_122(bVar41, 0));
				return bVar41;
			}
			iVar43++;
		}
...
{
	if (func_55(bParam0) == -126813555 || func_55(bParam0) == 1946043663)
	{
		return true;
	}
	return false;
...
int func_147(int iParam0, int iParam1, bool bParam2)
{
	...
	DEBUG::_0xA308F935BDECCEC0(168, 157, "CASHINVENTORY_FIRE_AND_FORGET_ITEM_TRANSACTION - ", func_184(iParam0, 0), ", immediate = ", bParam2);
	...
	if (bParam2)
	{
		...
		{
			return func_187(func_186(iVar0, iParam0, iParam1), iVar0, iParam1);
		}
	}
	else
	{
		return func_188(NETSHOPPING::_CASHINVENTORY_TRANSACTION_FIRE_AND_FORGET_ITEM(iParam0, &iVar0, iParam1, 17), iVar0, iParam1);
	}
...
void func_148(int iParam0, struct<17> Param1)
{
	int iVar0;
	...
	while (iVar0 < Global_1272425.f_20)
	{
		if (Global_1272425.f_20.f_1[iVar0 /*21*/] == iParam0)
		{
			if (Global_1272425.f_20.f_1[iVar0 /*21*/].f_1 == 1 || Global_1272425.f_20.f_1[iVar0 /*21*/].f_1 == 5)
			{
				...
				DEBUG::_0x4DC69742196F818A(40, 205, "UPDATE_CASHINVENTORY_TRANSACTION_HANDLER_DATA -   eStatus:                        ", func_189(Global_1272425.f_20.f_1[iVar0 /*21*/].f_1, 0));
...
bool func_149(var uParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5)
{
	*iParam1 = 0;
	if (iParam4 < 1)
	{
	...
	if (iParam3 == 0)
	{
		iParam3 = func_60(bParam2, joaat("DEFAULT"));
		if (iParam3 == 0)
		{
...
struct<17> func_150(bool bParam0, var uParam1)
{
	struct<17> Var0;

	Var0.f_9 = 1;
	Var0.f_11 = -1591664384;
	Var0 = { func_94(bParam0, *uParam1, uParam1->f_4, 1) };
	Var0.f_4 = { *uParam1 };
	Var0.f_8 = bParam0;
...
bool func_152()
{
	return (func_191(joaat("UPGRADE_OFFHAND_HOLSTER"), 0, 0, 0) > 0 && func_192(func_94(joaat("WARDROBE"), func_95(1), 1034665895, 1), -234132662, 1, -1) != 0);
}
...
int func_153(bool bParam0, struct<4> Param1, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	if (bParam7)
	{
		DEBUG::_0x1B08D1EB9D8C4931(43688, 157, "PLAYER_INVENTORY_GET_ITEM_COUNT - eInventoryItem: ", func_33(bParam0, 0), " sParentGUID: ", UNK_0xD2E4270E5D98EEE4(&Param1), " eSlot: ", func_103(bParam5, 0), " bPlayerOnly: ", bParam6);
		Var1 = { func_94(bParam0, Param1, bParam5, bParam6) };
...
bool func_154(bool bParam0, int iParam1, int iParam2, bool bParam3)
{
	int iVar0;

	iVar0 = func_61(0);
	*iParam1 = { func_94(bParam0, func_89(0), bParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(iParam1))
	{
		DEBUG::_0xF0783374333FD8CE(2728, 139, "[SHOP_GET_INVENTORY_WEAPON_DATA] Invalid INVENTORY_ITEM_GUID for ", func_33(bParam0, 0), " eSlot: ", func_103(bParam3, 0), " iPlayerInventoryID: ", iVar0);
		return false;
	}
...
bool func_156(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	DEBUG::_0x1B08D1EB9D8C4931(40, 157, "PLAYER_INVENTORY_GET_ITEM_DATA -  SlotId:      ", func_103(iParam1->f_9, 0));
...
int func_158(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;

	iVar0 = func_27(bParam1, bParam2, 0, 0);
	iVar0 = (iVar0 + func_193(iParam0, bParam1));
	if (bParam3)
	{
		iVar0 = (iVar0 + func_194(bParam1, bParam4));
	}
	return iVar0;
}
...
void func_159(bool bParam0)
{
	...
	else if ((((func_121(Global_1940463.f_11701, 1224357681) != 0 && Global_1940463.f_11700 != 0) && Global_1940463.f_11700 != -2074770370) && !Global_1915867.f_20638) && !Global_1915867.f_22504.f_1)
	{
...
void func_161(float fParam0, int iParam1)
{
	if (fParam0 == 0f)
	{
...
void func_163(float fParam0, bool bParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	float fVar2;
...
void func_165(float fParam0, int iParam1)
{
	if (fParam0 == 0f)
	{
...
float func_166(int iParam0, float fParam1, bool bParam2)
{
	int iVar0;
	int iVar1;

	iVar0 = func_197();
	func_198(&iVar0, 0, 0, 0, 1, 0, 0);
	iVar1 = func_199(iParam0, 2);
	DEBUG::_0x1B08D1EB9D8C4931(8, 84, "_RPG_GLOBAL_APPLY_CORE_FIX_DEGRADE - Degrade Count: ", iVar1);
	if (func_201(iVar0, func_200(iParam0, 2), 1))
	{
		func_202(iParam0, 0, 2);
		iVar1 = 0;
		DEBUG::_0x1B08D1EB9D8C4931(8, 84, "_RPG_GLOBAL_APPLY_CORE_FIX_DEGRADE - Reseting Degrade Count to 0, it's a whole new day!");
		DEBUG::_0x1B08D1EB9D8C4931(40, 84, "_RPG_GLOBAL_APPLY_CORE_FIX_DEGRADE - Degrade Time of Day: ", func_203(iVar0));
		DEBUG::_0x1B08D1EB9D8C4931(40, 84, "_RPG_GLOBAL_APPLY_CORE_FIX_DEGRADE - Current Time of Day: ", func_203(func_200(iParam0, 2)));
	}
	if (iVar1 >= 2)
	{
		func_50(103, bParam2);
	...
	func_204(iParam0, func_197(), 2);
	func_202(iParam0, iVar1 + 1, 2);
	return fParam1;
}
...
float func_167(int iParam0, int iParam1)
{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_ATTRIBUTE_CORE_DISPLAY_STATE - Failed to retrieve Core Value for ", func_205(iParam0, 0), " Returning -1.0. This is really bad. ");
	return -1f;
}

int func_168(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5)
{
	int iVar0;
	...
	iVar0 = PLAYER::PLAYER_PED_ID();
	if (func_206(iVar0, iParam0, fParam1))
	{
		if (bParam2)
		{
			if (fParam1 >= 100f)
		...
		if (bParam3)
		{
			func_207(iParam0, 7000, iParam5);
		}
		func_208(iVar0, iParam0, fParam1);
		DEBUG::_0xA308F935BDECCEC0(10664, 84, "__RPG_GLOBAL_SET_PLAYER_ATTRIBUTE_CORE - Caching Player Attribute Core ", func_205(iParam0, 0), " Value Data. Setting to: ", fParam1, " Override Enabled: ", MISC::_0xF216F74101968DB0(func_209()));
		func_210(iParam0, fParam1, bParam4, iParam5);
	}
	return 1;
}
...
int func_170(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	...
	iVar1 = PLAYER::PLAYER_PED_ID();
	DEBUG::_0xF0783374333FD8CE(2472, 84, "__RPG_GLOBAL_SET_OVERPOWER_FOR_PLAYER_ATTRIBUTE_INTERNAL - Attribute: ", func_169(iParam0, 0), " will be Overpowered this frame for  ", fParam1, " seconds on local player...");
	if (fParam1 == -1f)
	{
		if (func_211(iParam0))
		{
	...
	{
		DEBUG::_0x6D2A5155B260E879(2472, 84, "__RPG_GLOBAL_SET_OVERPOWER_FOR_PLAYER_ATTRIBUTE_INTERNAL - Attribute: ", func_169(iParam0, 0), " was set to a Duration of: ", fParam1, " this is really bad. Correct this. ");
		return 0;
	}
	switch (iParam0)
	{
		...
		case 1:
			...
			func_213(joaat("STATUS_EFFECT__TRACKING"));
			func_113(-1);
			ATTRIBUTE::ENABLE_ATTRIBUTE_OVERPOWER(iVar1, iParam0, fParam1, bParam3);
		...
		case 2:
			...
			break;
		case 19:
			func_213(joaat("STATUS_EFFECT__POISON"));
			func_214(0, 1, 1);
			ATTRIBUTE::ENABLE_ATTRIBUTE_OVERPOWER(iVar1, iParam0, fParam1, bParam3);
		...
		case 20:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(168, 84, "__RPG_GLOBAL_SET_OVERPOWER_FOR_PLAYER_ATTRIBUTE_INTERNAL - Attribute: ", func_169(iParam0, 0), " cannot be overpowered... Why are you doing this?");
			return 0;
	}
	return 1;
}
...
bool func_171()
{
	...
	return func_215(Global_1957252.f_1431.f_107, 0);
}

void func_172(float fParam0, bool bParam1)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	fVar0 = func_216(13, 2);
	iVar1 = func_217(fVar0);
	fVar0 = (fVar0 + fParam0);
	fVar0 = func_218(fVar0, 0f, 100f);
	iVar2 = func_217(fVar0);
	...
	if (iVar1 != iVar2)
	{
		Global_1957252.f_1431.f_107 = func_197();
		func_219(&(Global_1957252.f_1431.f_107), 0, 0, 1, 0, 0, 0, 0);
	}
	func_220(13, fVar0, 2);
...
char* func_173(int iParam0, int iParam1)
{
	...
	{
		case 0:
			return "LA_PHEROMONE_VIAL_EVENT_INVALID";
		case 1:
			return "LA_PHEROMONE_VIAL_EVENT_ITEM_USED";
		case 2:
			return "LA_PHEROMONE_VIAL_EVENT_PLAY_VOCALIZATION";
		default:
			break;
	}
	if (iParam1 >= 1)
...
{
	return func_221(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("VOLCYLINDER"), iParam0, iParam1);
}
...
bool func_178(int iParam0)
{
	...
	while (iVar0 < Global_38.f_3538)
	{
		if (Global_38.f_3538[iVar0 /*3*/].f_2 == iParam0)
		{
			...
			DEBUG::_0x1B08D1EB9D8C4931(168, 105, "IS_TIMED_TUTORIAL_DELAYED_OR_FINISHED time since last played tutorial ", func_177(iParam0, 0), " Seconds ", iVar2);
...
bool func_185(int iParam0, int iParam1)
{
	...
	DEBUG::_0xA308F935BDECCEC0(2728, 157, "CASHINVENTORY_VALIDATE_TRANSACTION_ITEM - ", func_184(iParam0, 0), " -> ", func_33(iParam1->f_8, 0), " has iFailedValidationFlags = ", sVar0);
	if (iParam0 == joaat("USE"))
	{
		if ((func_223(iParam1->f_8, iParam0, sVar0, 2048) || func_223(iParam1->f_8, iParam0, sVar0, 32768)) || func_223(iParam1->f_8, iParam0, sVar0, 65536))
		{
			return false;
		}
	}
	...
	{
		if (((func_223(iParam1->f_8, iParam0, sVar0, 4) || func_223(iParam1->f_8, iParam0, sVar0, 256)) || func_223(iParam1->f_8, iParam0, sVar0, 65536)) || func_223(iParam1->f_8, iParam0, sVar0, 131072))
		{
			return false;
		}
	}
	...
	{
		if (((func_223(iParam1->f_8, iParam0, sVar0, 1) || func_223(iParam1->f_8, iParam0, sVar0, 8)) || func_223(iParam1->f_8, iParam0, sVar0, 65536)) || func_223(iParam1->f_8, iParam0, sVar0, 32))
		{
			return false;
		}
	}
	...
	{
		if (((func_223(iParam1->f_8, iParam0, sVar0, 1) || func_223(iParam1->f_8, iParam0, sVar0, 16)) || func_223(iParam1->f_8, iParam0, sVar0, 2)) || func_223(iParam1->f_8, iParam0, sVar0, 65536))
		{
			return false;
		}
	}
	else if (((func_223(iParam1->f_8, iParam0, sVar0, 8) || func_223(iParam1->f_8, iParam0, sVar0, 4096)) || func_223(iParam1->f_8, iParam0, sVar0, 256)) || func_223(iParam1->f_8, iParam0, sVar0, 65536))
	{
		return false;
	}
	return true;
...
int func_188(bool bParam0, char* sParam1, int iParam2)
{
	if (bParam0)
	{
...
bool func_190(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	*iParam1 = 0;
	...
	while (iVar0 < 10)
	{
		...
		else if (func_225(uParam0[iVar0 /*6*/]))
		{
		}
		else
		{
			...
			if ((uParam0[iVar0 /*6*/])->f_5 > iParam2)
			{
				...
				iParam2 = 0;
				DEBUG::_0x4DC69742196F818A(2696, 157, "PLAYER_INVENTORY_FILLOUT_ITEM_PLACEMENTS - Found quantity ", (uParam0[*iParam1 /*6*/])->f_5, " in ", func_103((uParam0[*iParam1 /*6*/])->f_4, 0), ", 0 Remaining");
			}
			else
			{
				(uParam0[*iParam1 /*6*/])->f_5 = (uParam0[iVar0 /*6*/])->f_5;
				iParam2 = (iParam2 - (uParam0[*iParam1 /*6*/])->f_5);
				DEBUG::_0x4DC69742196F818A(35464, 157, "PLAYER_INVENTORY_FILLOUT_ITEM_PLACEMENTS - Found quantity ", (uParam0[*iParam1 /*6*/])->f_5, " in ", func_103((uParam0[*iParam1 /*6*/])->f_4, 0), ", ", iParam2, " Remaining");
			}
			if (iVar0 > *iParam1)
			{
				*(uParam0[iVar0 /*6*/]) = { func_151() };
...
int func_192(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, int iParam6)
{
	return func_227(&uParam0, bParam4, bParam5, iParam6);
}
...
int func_193(int iParam0, bool bParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		...
		{
			return func_229(INVENTORY::_INVENTORY_GET_PED_INVENTORY_ID(iParam0), bParam1);
		}
	}
	return 0;
}
...
int func_194(bool bParam0, bool bParam1)
{
	if (!bParam1 || func_230())
	{
		return func_153(bParam0, func_95(1), -2015960939, 1, 1, 0);
	}
	return 0;
}
...
void func_198(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar0 = (iVar0 - iParam6);
	func_241(iParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}
...
int func_199(int iParam0, int iParam1)
{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_ATTRIBUTE_CORE_DEGRADE_COUNT - Failed to retrieve Core Degrade Count for ", func_205(iParam0, 0), " Returning -1. This is really bad. ");
	return -1;
}
...
int func_200(int iParam0, int iParam1)
{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_ATTRIBUTE_CORE_DEGRADE_TIME_OF_DAY - Failed to retrieve Core Degrade Time of Day for ", func_205(iParam0, 0), " Returning -1. This is really bad. ");
	return -15;
}
...
void func_202(int iParam0, char* sParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DEGRADE_COUNT - Setting Core Degrade Count for ", func_205(iParam0, 0), " Pool: ", func_243(iParam2), " to ", sParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DEGRADE_COUNT - Failed to set Core Degrade Count for ", func_205(iParam0, 0), " Pool: ", func_243(iParam2), ". This is really bad. ");
			break;
	}
}
...
void func_204(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(10920, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DEGRADE_TIME_OF_DAY - Setting Core Degrade Time of Day for ", func_205(iParam0, 0), " Pool: ", func_243(iParam2), " to ", func_203(iParam1));
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DEGRADE_TIME_OF_DAY - Failed to set Core Degrade Time of Day for ", func_205(iParam0, 0), " Pool: ", func_243(iParam2), ". This is really bad. ");
			break;
	}
}
...
bool func_206(int iParam0, int iParam1, float fParam2)
{
	...
	ATTRIBUTE::_SET_ATTRIBUTE_CORE_VALUE(iParam0, func_245(iParam1), BUILTIN::CEIL(fParam2));
	return true;
}
...
void func_207(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DISPLAY_TIME - Setting Core Display Time for ", func_205(iParam0, 0), " Pool: ", func_243(iParam2), " to ", iParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_DISPLAY_TIME - Failed to set Core Display Time for ", func_205(iParam0, 0), " Pool: ", func_243(iParam2), ". This is really bad. ");
			break;
	}
}
...
void func_208(int iParam0, int iParam1, float fParam2)
{
	...
	sVar0 = func_246(iParam1);
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		PED::_SET_PED_BLACKBOARD_FLOAT(iParam0, func_247(iParam1), fParam2, -1);
	}
	else
	{
		DEBUG::_0x6D2A5155B260E879(40, 84, "__RPG_GLOBAL_HANDLE_BLACKBOARD_FOR_ATTRIBUTE - INVALID BLACK BOARD NAME for Attribute Core: ", func_205(iParam1, 0));
	}
}
...
void func_210(int iParam0, char* sParam1, bool bParam2, int iParam3)
{
	char* sVar0;
	...
	DEBUG::_0xA308F935BDECCEC0(43432, 84, "__RPG_GLOBAL_CACHE_ATTRIBUTE_CORE_DATA - Caching Attribute Core ", func_205(iParam0, 0), " Value Data. Setting to: ", sParam1, " Override Enabled: ", MISC::_0xF216F74101968DB0(func_209()), " Time Stamp: ", sVar0);
	func_248(iParam0, sParam1, iParam3);
	if (bParam2)
	{
		func_249(iParam0, sVar0, iParam3);
	}
}
...
char* func_212(int iParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(168, 84, "RPG_GLOBAL_GET_OVERPOWER_POSTFX_STRING_FOR_ATTRIBUTE - Attribute: ", func_169(iParam0, 0), " does not have an overpower post fx... Returning NULL ");
	return "";
}
...
void func_213(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 84, "RPG_GLOBAL__DISABLE_ALL_STATUS_EFFECT_SOURCES_OF_TYPE - Now disabling all Status Effects with Perk Group: ", func_250(iParam0, 0));
	iVar1 = Global_1146683.f_47689.f_1.f_42;
	iVar2 = 0;
	while (iVar2 < iVar1)
	{
		iVar0 = Global_1146683.f_47689.f_1[iVar2 /*2*/];
		iVar3 = func_251(iVar0, 1);
		if (Global_1146683.f_35859.f_919[iVar3 /*12*/] == iParam0)
		{
			DEBUG::_0xA308F935BDECCEC0(168, 84, "RPG_GLOBAL__DISABLE_ALL_STATUS_EFFECT_SOURCES_OF_TYPE - Disabling Source: ", func_252(Global_1146683.f_47689.f_1[iVar2 /*2*/], 0), " at index: ", iVar2);
			func_253(iVar0);
...
{
	func_168(iParam0, 100f, bParam1, bParam2, 1, 2);
}

bool func_215(int iParam0, bool bParam1)
{
	return func_201(func_197(), iParam0, bParam1);
}
...
float func_216(int iParam0, int iParam1)
{
	...
	{
		case 0:
			DEBUG::_0x1B08D1EB9D8C4931(424, 84, "[RPG_GLOBAL_GET_CACHED_PLAYER_ATTRIBUTE_XP] Pool for Attributes: ", func_254(0, 0), " Value: ", Global_1957252.f_1431.f_26[iParam0]);
			return Global_1957252.f_1431.f_26[iParam0];
		case 1:
			DEBUG::_0x1B08D1EB9D8C4931(424, 84, "[RPG_GLOBAL_GET_CACHED_PLAYER_ATTRIBUTE_XP] Pool for Attributes: ", func_254(1, 0), " Value: ", Global_1957252.f_1565.f_2.f_26[iParam0]);
			return Global_1957252.f_1565.f_2.f_26[iParam0];
		default:
			break;
	}
	DEBUG::_0x6D2A5155B260E879(40, 84, "[RPG_GLOBAL_GET_CACHED_PLAYER_ATTRIBUTE_XP] Couldn't retrieve Cached Attribute XP data for Attribute: ", func_169(iParam0, 0));
	return -1f;
}
...
void func_219(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_220(int iParam0, char* sParam1, int iParam2)
{
	...
	DEBUG::_0xA308F935BDECCEC0(10664, 84, "__RPG_GLOBAL_SET_PLAYER_ATTRIBUTE - Caching Attribute ", func_169(iParam0, 0), " XP Data. Setting to: ", sParam1, " Override Enabled: ", MISC::_0xF216F74101968DB0(func_209()));
	func_256(iParam0, sParam1, iParam2);
...
var func_221(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	else
	{
		switch (iParam9)
		{
			case joaat("VOLCYLINDER"):
				iVar8 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_258());
				break;
			case joaat("VOLSPHERE"):
				iVar8 = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_258());
				break;
			case joaat("VOLBOX"):
				iVar8 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_258());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_259(PLAYER::GET_PLAYER_TEAM(iVar5)));
	}
	...
	while (iVar2 < 32)
	{
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(Global_1275959.f_154[iVar2]))
		{
			...
			if (!bVar3)
			{
				if (iVar9 & 8192 != 0 && func_261(iVar2) != 1)
				{
					bVar3 = true;
				}
			}
...
int func_223(var uParam0, int iParam1, char* sParam2, int iParam3)
{
	if (func_263(sParam2, iParam3))
	{
		return 1;
	}
	return 0;
...
void func_224(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	while (iVar0 < Global_1272425.f_20)
	{
		if (Global_1272425.f_20.f_1[iVar0 /*21*/] == iParam0)
		{
			...
			{
				DEBUG::_0x4DC69742196F818A(648, 157, "UPDATE_CASHINVENTORY_TRANSACTION_STATUS - Transaction ", iParam0, " status was already ", func_189(Global_1272425.f_20.f_1[iVar0 /*21*/].f_1, 0));
			}
			else
			{
				DEBUG::_0xA308F935BDECCEC0(10888, 157, "UPDATE_CASHINVENTORY_TRANSACTION_STATUS - Updated transaction ", iParam0, " status from ", func_189(Global_1272425.f_20.f_1[iVar0 /*21*/].f_1, 0), " to ", func_189(iParam1, 0));
				Global_1272425.f_20.f_1[iVar0 /*21*/].f_1 = iParam1;
			}
			if (iParam2 != 0 && iParam3 != 0)
			{
				DEBUG::_0xA308F935BDECCEC0(10888, 157, "UPDATE_CASHINVENTORY_TRANSACTION_STATUS - Updated transaction ", iParam0, " batch action A to ", func_184(iParam2, 0), " and action B to ", func_184(iParam3, 0));
	...
	func_264(iParam0, iParam1, iParam2, iParam3);
}
...
int func_227(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	Var0.f_9 = -1591664384;
	if (func_266(iParam0, bParam1, &Var0, bParam2, iParam3))
	{
...
{
	return func_270(&(Global_1957252.f_1565), iParam0, 1);
}
...
{
	return (PLAYER::_0x592F58BC4D2A2CF3(iParam0, 0) - IntToFloat(func_271(2)));
}
...
void func_241(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
int func_245(int iParam0)
{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_PED_ATTRIBUTE_FROM_RPG_GLOBAL_CORE - Attribute Core: ", func_205(iParam0, 0), " does not have an associated PED Attribute. This is REALLY bad, correct immediately... ");
	return 0;
}
...
void func_248(int iParam0, char* sParam1, int iParam2)
{
	if (iParam2 == 2)
	{
		iParam2 = func_195(2);
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(6824, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_VALUE - Setting Core Value for ", func_205(iParam0, 0), " Pool: ", func_243(iParam2), " to ", sParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_VALUE - Failed to set Core Value for ", func_205(iParam0, 0), " Pool: ", func_243(iParam2), ". This is really bad. ");
			break;
	}
}

void func_249(int iParam0, char* sParam1, int iParam2)
{
	if (iParam2 == 2)
	{
		iParam2 = func_195(2);
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_LAST_UPDATED_TIMESTAMP - Setting Last Updated Timestamp for ", func_205(iParam0, 0), " Pool: ", func_243(iParam2), " to ", sParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_ATTRIBUTE_CORE_LAST_UPDATED_TIMESTAMP - Failed to set Last Updated Timestamp for ", func_205(iParam0, 0), " Pool: ", func_243(iParam2), ". This is really bad. ");
			break;
	}
}
...
int func_253(int iParam0)
{
	...
	if (!func_280(Global_1146683.f_35859.f_919[iVar0 /*12*/]))
	{
		return 1;
	}
	iVar3 = func_281(Global_1146683.f_35859.f_919[iVar0 /*12*/], 1);
	DEBUG::_0xA308F935BDECCEC0(2216, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Attempting to disable all Perks in Perk Group: ", func_250(Global_1146683.f_35859.f_919[iVar0 /*12*/], 0), " it has: ", Global_1146683.f_35859[iVar3 /*6*/].f_5, " perks...");
	iVar4 = 0;
	while (iVar4 < Global_1146683.f_35859[iVar3 /*6*/].f_5)
	{
		iVar1 = Global_1146683.f_35859[iVar3 /*6*/][iVar4];
		DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Disabling Perk: ", func_282(iVar1, 0), " from Source: ", func_252(iParam0, 0));
		switch (func_283(iParam0, iVar1))
		{
			case 0:
				DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - deactivating perk ", func_282(iVar1, 0), " directly");
				func_284(iVar1, iParam0, iVar4);
				break;
			case 1:
				iVar5 = 0;
				while (iVar5 < Global_1146683.f_35859.f_11700)
				{
					...
					{
						DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - removing perk ", func_282(iVar1, 0), " from the activation queue");
						func_284(iVar1, iParam0, iVar4);
						func_285(&(Global_1146683.f_35859.f_9503[iVar5 /*3*/]));
						...
						func_285(&(Global_1146683.f_35859.f_9503[Global_1146683.f_35859.f_11700 /*3*/]));
					}
					else
					{
						iVar5++;
				...
				break;
			case 2:
				DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - ignoring perk ", func_282(iVar1, 0), "...");
				Jump @1002; //curOff = 566
				iVar2 = func_286(iVar1, 1);
				DEBUG::_0xA308F935BDECCEC0(2216, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Perk: ", func_282(iVar1, 0), " currently has num sources: ", Global_1146683.f_35859.f_3116[iVar2 /*31*/].f_29, " remaining... ");
				func_287(iVar2, -1);
				DEBUG::_0xA308F935BDECCEC0(2216, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Perk: ", func_282(iVar1, 0), " has num sources: ", Global_1146683.f_35859.f_3116[iVar2 /*31*/].f_29, " remaining... ");
				if (Global_1146683.f_35859.f_3116[iVar2 /*31*/].f_29 <= 0)
				{
					func_288(iVar2, 0);
					DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - all sources for Perk: ", func_282(iVar1, 0), " have been removed, disabling it");
					iVar6 = 0;
					while (iVar6 < Global_1146683.f_35859.f_9502)
					{
						if (Global_1146683.f_35859.f_9302[iVar6] != iVar1)
						{
							DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Evaluated Perk: ", func_282(iVar1, 0), " does not equal perk in slot: ", func_282(Global_1146683.f_35859.f_9302[iVar6], 0));
						}
						else
						{
							DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL__DISABLE_PERK_SOURCE_INTERNAL - Evaluated Perk: ", func_282(iVar1, 0), " matches perk in slot! ");
			...
			func_289(&(Global_1146683.f_35859.f_919[iVar0 /*12*/]));
			return 1;
		}

char* func_254(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case 0:
...
void func_256(int iParam0, float fParam1, int iParam2)
{
	...
	switch (iParam2)
	{
		case 0:
			...
			DEBUG::_0xF0783374333FD8CE(6824, 84, "__RPG_GLOBAL_SET_CACHED_ATTRIBUTE_XP - Setting Attribute XP for ", func_169(iParam0, 0), " Pool: ", func_243(iParam2), " to ", fParam1);
			break;
		case 1:
			...
			break;
		default:
			DEBUG::_0x6D2A5155B260E879(2728, 84, "__RPG_GLOBAL_SET_CACHED_ATTRIBUTE_XP - Failed to set Attribute XP for ", func_169(iParam0, 0), " Pool: ", func_243(iParam2), ". This is really bad. ");
			break;
	}
}
...
bool func_263(char* sParam0, int iParam1)
{
...
void func_264(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	func_294(&(Global_1272425.f_20.f_1[(Global_1272425.f_20 - 1) /*21*/]));
	...
	if (iParam2 != 0 && iParam3 != 0)
	{
		...
		DEBUG::_0xA308F935BDECCEC0(10888, 157, "ADD_CASHINVENTORY_TRANSACTION_STATUS - Added transaction ", iParam0, " with batch action A ", func_184(iParam2, 0), " and action B ", func_184(iParam3, 0));
	}
	DEBUG::_0xA308F935BDECCEC0(648, 157, "ADD_CASHINVENTORY_TRANSACTION_STATUS - Added transaction ", iParam0, " with status ", func_189(iParam1, 0));
}
...
bool func_266(int iParam0, bool bParam1, int iParam2, bool bParam3, int iParam4)
{
	var uVar0;
	...
	{
		DEBUG::_0x9A6C65DDDBEC9C52(40, 157, "PLAYER_INVENTORY_GET_ITEM_DATA_EQUIPPED_IN_SLOT_BY_REF - nothing is equipped for slot ", func_103(bParam1, 0));
		return false;
	}
	if (!func_156(&uVar0, iParam2, bParam3, 0, iParam4))
	{
		DEBUG::_0xD9911C7B5F8CD69C(40, 157, "PLAYER_INVENTORY_GET_ITEM_DATA_EQUIPPED_IN_SLOT_BY_REF - failed to get equipment data for slot ", func_103(bParam1, 0));
		return false;
	}
	DEBUG::_0x1B08D1EB9D8C4931(10920, 157, "PLAYER_INVENTORY_GET_ITEM_DATA_EQUIPPED_IN_SLOT_BY_REF - ", func_33(iParam2->f_4, 0), " (", UNK_0xD2E4270E5D98EEE4(iParam2), ") is equipped in slot ", func_103(bParam1, 0));
	return true;
}
...
struct<4> func_268(int iParam0, bool bParam1)
{
	struct<5> Var0;

	Var0 = { func_296(iParam0) };
	return func_297(iParam0, bParam1, Var0, Var0.f_4);
}
...
int func_271(int iParam0)
{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "RPG_GLOBAL_GET_ATTRIBUTE_CORE_MAX_SIZE - Attribute Core: ", func_205(iParam0, 0), " is INVALID. Correct this immediately... ");
	return -1;
}
...
void func_275(int iParam0, int iParam1)
{
	...
	{
		DEBUG::_0x83407B92D46F25C3(559240, 0, "SET_TIMEOFDAY_DAY: Passed an invalid day [", iParam1, "] for the TIMEOFDAY's current month [", iVar0, "] for year ", iVar1, ". GET_NUMBER_OF_DAYS_IN_MONTH(eMonth, iYear) = ", func_240(iVar0, iVar1), ". Failed to set TIMEOFDAY.");
		return;
	}
...
int func_283(int iParam0, int iParam1)
{
	...
	iVar2 = func_286(iParam1, 1);
	DEBUG::_0x1B08D1EB9D8C4931(10920, 84, "RPG_GLOBAL_STAT_GET_DEACTIVATION_TYPE - Source: ", func_252(iParam0, 0), " Perk: ", func_282(iParam1, 0), " Deactivation Trigger: ", func_299(Global_1146683.f_35859.f_3116[iVar2 /*31*/].f_1, 0));
...
int func_284(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = func_286(iParam0, 1);
	func_301(iParam0, iParam1, iParam2);
	if (func_302(Global_1146683.f_35859.f_3116[iVar0 /*31*/]) && func_303(iParam0, Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4))
	{
		DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK - Now checking Stack Group: ", func_304(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, 0), " for any perks that could be enabled now that this perk is diabled... ");
		vVar1 = { func_305(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4) };
		if (func_306(vVar1))
		{
			if (func_307(vVar1.x, vVar1.y, vVar1.z))
			{
				func_308(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, vVar1.x, vVar1.y, vVar1.z);
			}
			else
			{
				func_309(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4);
				DEBUG::_0x6D2A5155B260E879(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK - Failed to activate next availible perk in Stack Group: ", func_304(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, 0), " there was a critical failure... ");
			}
		}
		else
		{
			func_309(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4);
			DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK - No suitable replacement for active perk in Stack Group: ", func_304(Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_4, 0), "...");
		}
	}
	return 1;
}
...
void func_287(int iParam0, int iParam1)
{
	...
	DEBUG::_0xF0783374333FD8CE(2216, 84, "__RPG_GLOBAL__ALTER_SOURCES_FOR_PERK_ID - Perk: ", func_282(func_310(iParam0, 1), 0), " is being altered by: ", iParam1, " to a total of: ", Global_1146683.f_35859.f_3116[iParam0 /*31*/].f_29);
}

void func_288(int iParam0, int iParam1)
{
	Global_1146683.f_35859.f_3116[iParam0 /*31*/].f_29 = iParam1;
	DEBUG::_0xF0783374333FD8CE(168, 84, "__RPG_GLOBAL__SET_SOURCES_FOR_PERK_ID - Perk: ", func_282(func_310(iParam0, 1), 0), " is being set to: ", Global_1146683.f_35859.f_3116[iParam0 /*31*/].f_29);
}
...
bool func_291(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_270(&(Global_1102630.f_4), iVar0, 5);
	}
	if (iParam1 == func_311())
	{
		return func_270(&(Global_1102630.f_4), iVar0, 5);
	...
	{
		return func_270(&(Global_1100880[iParam1 /*53*/].f_4), iVar0, 5);
	}
...
struct<5> func_296(int iParam0)
{
	struct<5> Var0;

	Var0 = { func_297(iParam0, joaat("CHARACTER"), func_151(), -1591664384) };
	Var0.f_4 = 1084182731;
	return Var0;
}

struct<4> func_297(int iParam0, bool bParam1, var uParam2, int iParam3, var uParam4, var uParam5, bool bParam6)
{
	struct<4> Var0;
...
int func_301(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = func_251(iParam1, 1);
	iVar1 = func_286(iParam0, 1);
	iVar2 = func_281(Global_1146683.f_35859.f_919[iVar0 /*12*/], 1);
	if (Global_1146683.f_35859[iVar2 /*6*/][iParam2] != iParam0)
	{
		DEBUG::_0x9A6C65DDDBEC9C52(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK_INTERNAL - attempting to disable perk ", func_282(iParam0, 0), " from a source that hasn't previously enabled it ", func_252(iParam1, 0));
		return 0;
	}
	...
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK_INTERNAL - deactivating perk ", func_282(iParam0, 0), " and source ", func_252(iParam1, 0));
	...
	while (iVar4 < Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_16)
	{
		...
		else
		{
			...
			Global_1146683.f_2169[iVar5 /*205*/].f_201 = (Global_1146683.f_2169[iVar5 /*205*/].f_201 - func_319(&(Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/])));
			DEBUG::_0xA308F935BDECCEC0(6824, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_PERK_INTERNAL - removing perk ", func_282(iParam0, 0), " to stat mod ", func_320(iVar3, 0), " with strength ", Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/].f_1);
			func_321(iVar3);
		}
		iVar4++;
	}
...
bool func_302(struct<5> Param0, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30)
{
	return Param0.f_4 != 0;
}
...
{
	if (!func_300(vParam0.x))
	{
		return false;
	}
	if (!func_279(vParam0.y))
	{
		return false;
	}
	if (!func_328(vParam0.z))
	{
		return false;
	}
	return true;
...
bool func_307(int iParam0, int iParam1, int iParam2)
{
	...
	if (Global_1146683.f_35859[iVar2 /*6*/][iParam2] != iParam0)
	{
		DEBUG::_0x9A6C65DDDBEC9C52(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - attempting to disable perk ", func_282(iParam0, 0), " from a source that hasn't previously enabled it ", func_252(iParam1, 0));
		return false;
	}
	...
	DEBUG::_0xA308F935BDECCEC0(2728, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK - activating perk ", func_282(iParam0, 0), " and source ", func_252(iParam1, 0), " at POSIX time: ", Global_1275959.f_21);
	...
	while (iVar4 < Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_16)
	{
		...
		else
		{
			...
			Global_1146683.f_2169[iVar5 /*205*/].f_201 = (Global_1146683.f_2169[iVar5 /*205*/].f_201 + func_319(&(Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/])));
			DEBUG::_0xA308F935BDECCEC0(6824, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - adding perk ", func_282(iParam0, 0), " to stat mod ", func_320(iVar3, 0), " with strength ", func_319(&(Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/])));
			DEBUG::_0xA308F935BDECCEC0(6824, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - adding perk ", func_282(iParam0, 0), " to stat mod ", func_320(iVar3, 0), " with total ", Global_1146683.f_2169[iVar5 /*205*/].f_201);
			func_329(iVar3);
		}
		iVar4++;
	}
	DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - perk: ", func_282(iParam0, 0), " Flag Count: ", Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_28);
	iVar7 = 0;
	while (iVar7 < Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_28)
	{
		iVar6 = Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_17[iVar7 /*2*/];
		if (!func_322(iVar6))
		{
			DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - Flag: ", func_330(iVar6, 0), " is not valid... skipping... ");
		}
		else if (!func_331(&(Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_17[iVar7 /*2*/])))
		{
			DEBUG::_0xA308F935BDECCEC0(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - Flag: ", func_330(iVar6, 0), " is not currently disabled by tunables... skipping... ");
		}
		else
		{
			iVar8 = func_323(iVar6, 1);
			...
			{
				DEBUG::_0xA308F935BDECCEC0(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_PERK_INTERNAL - Turning on flag ", func_330(iVar6, 0));
	...
	func_333(Global_1146683.f_35859.f_3116[iVar1 /*31*/].f_2);
	return true;
}
...
void func_308(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (!func_325(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 84, "__RPG_GLOBAL_STACKING_SET_STACK_GROUP_DATA - Perk Group: ", func_304(iParam0, 0), " is not valid... Bailing out... ");
		return;
	}
	iVar0 = func_326(iParam0, 1);
	if (!func_300(iParam1))
	{
		DEBUG::_0x83407B92D46F25C3(168, 84, "__RPG_GLOBAL_STACKING_SET_STACK_GROUP_DATA - Perk: ", func_282(iParam1, 0), " is not valid... Bailing out... ");
		return;
	}
	if (!func_279(iParam2))
	{
		DEBUG::_0x83407B92D46F25C3(168, 84, "__RPG_GLOBAL_STACKING_SET_STACK_GROUP_DATA - Source: ", func_252(iParam2, 0), " is not valid... Bailing out... ");
		return;
	}
	if (!func_328(iParam3))
	{
	...
	DEBUG::_0xF0783374333FD8CE(680, 84, "__RPG_GLOBAL_STACKING_SET_STACK_GROUP_DATA - Setting Perk: ", func_282(iParam1, 0), " active for Perk Group: ", func_304(iParam0, 0));
...
void func_309(int iParam0)
{
	...
	iVar0 = func_326(iParam0, 1);
	DEBUG::_0xF0783374333FD8CE(680, 84, "__RPG_GLOBAL_STACKING_SET_STACK_GROUP_DATA_AS_INVALID - Setting Perk: ", func_282(-1, 0), " active for Perk Group: ", func_304(iParam0, 0));
...
bool func_319(var uParam0)
{
	...
	if (uParam0->f_2 != 0)
	{
		DEBUG::_0xF0783374333FD8CE(168, 84, "RPG_GLOBAL_STATS_GET_STAT_MOD_IMPACT - Stat Mod: ", func_320(*uParam0, 0), " has a Tunable associated with impact, looking up... ");
		bVar0 = func_340(794259616, uParam0->f_2, uParam0->f_1, "");
		DEBUG::_0xF0783374333FD8CE(424, 84, "RPG_GLOBAL_STATS_GET_STAT_MOD_IMPACT - Stat Mod: ", func_320(*uParam0, 0), " has an associated Tunable with impact: ", bVar0);
		return bVar0;
	}
	DEBUG::_0xF0783374333FD8CE(424, 84, "RPG_GLOBAL_STATS_GET_STAT_MOD_IMPACT - Stat Mod: ", func_320(*uParam0, 0), " using default Impact: ", uParam0->f_1);
	return uParam0->f_1;
}
...
void func_321(int iParam0)
{
	...
	if (!func_318(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__UNSUBSCRIBE_STAT_MOD - Stat Mod: ", func_320(iParam0, 0), " is Invalid... ");
		return;
	}
	iVar0 = func_317(iParam0, 1);
	if (!func_341(Global_1146683.f_2169[iVar0 /*205*/]))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__UNSUBSCRIBE_STAT_MOD - no RPG stat associated with stat mod ", func_320(iParam0, 0));
		return;
	}
	...
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__UNSUBSCRIBE_STAT_MOD - stat mod ", func_320(iParam0, 0), " is no longer impacting stat ", func_342(Global_1146683.f_2169[iVar0 /*205*/], 0));
	Global_1146683.f_2169[iVar0 /*205*/].f_204 = 0;
	if (!func_343(Global_1146683.f_2169[iVar0 /*205*/].f_203))
	{
		return;
	}
	iVar1 = func_344(Global_1146683.f_2169[iVar0 /*205*/].f_203, 1);
	...
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__UNSUBSCRIBE_STAT_MOD - removing stat ", func_342(Global_1146683.f_2169[iVar0 /*205*/], 0), " from subscribed action ", func_345(Global_1146683.f_2169[iVar0 /*205*/].f_203, 0));
	iVar2 = 0;
...
void func_324(int iParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_STAT_FLAG - Now Disabling Stat Flag: ", func_330(iParam0, 0));
	iVar0 = PLAYER::PLAYER_PED_ID();
	iVar1 = PLAYER::PLAYER_ID();
	switch (iParam0)
	{
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
		case joaat("SLOW_AND_STEADY_VFX"):
			DEBUG::_0xF0783374333FD8CE(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__DEACTIVATE_STAT_FLAG - Remove VFX ", func_330(iParam0, 0));
...
int func_327(int iParam0)
{
	...
	{
		iVar64 = func_286(Global_1146683.f_35859.f_9503[iVar65 /*3*/], 1);
		DEBUG::_0x1B08D1EB9D8C4931(168, 84, "RPG_GLOBAL_GET_ACTIVATION_QUEUE_PERK_INDEX_FROM_NEXT_AVAILIBLE_PERK_IN_STACK_GROUP - Now processing Perk: ", func_282(Global_1146683.f_35859.f_9503[iVar65 /*3*/], 0), "...");
		...
		else if (!func_353(Global_1146683.f_35859.f_9503[iVar65 /*3*/], Global_1146683.f_35859.f_9503[iVar65 /*3*/].f_1))
		{
		}
		else
		{
			Var1 = { func_354(Global_1146683.f_35859.f_9503[iVar65 /*3*/]) };
...
void func_329(int iParam0)
{
	...
	if (!func_318(iParam0))
	{
		DEBUG::_0x83407B92D46F25C3(168, 84, "__RPG_GLOBAL_STATS__PRIVATE__SUBSCRIBE_STAT_MOD - Stat Mod: ", func_320(iParam0, 0), " is Invalid... ");
		return;
	}
	iVar0 = func_317(iParam0, 1);
	if (!func_341(Global_1146683.f_2169[iVar0 /*205*/]))
	{
		DEBUG::_0x9A6C65DDDBEC9C52(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__SUBSCRIBE_STAT_MOD - no RPG stat associated with stat mod ", func_320(iParam0, 0));
		return;
	}
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__SUBSCRIBE_STAT_MOD - subcribing stat mod ", func_320(iParam0, 0), " to stat ", func_342(Global_1146683.f_2169[iVar0 /*205*/], 0));
	...
	DEBUG::_0xA308F935BDECCEC0(680, 84, "__RPG_GLOBAL_STATS__PRIVATE__SUBSCRIBE_STAT_MOD - adding stat ", func_342(Global_1146683.f_2169[iVar0 /*205*/], 0), " to action ", func_345(Global_1146683.f_2169[iVar0 /*205*/].f_203, 0));
...
char* func_330(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case joaat("EAGLE_EYE_HIGHLIGHT_BOUNTIES"):
...
bool func_331(var uParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(680, 84, "RPG_GLOBAL_STATS_IS_STAT_FLAG_TUNABLE_ENABLED - Stat Flag: ", func_330(*uParam0, 0), " Associated Tunable: ", UNK_0x4379B6FA65D55295(uParam0->f_1));
	if (uParam0->f_1 != 0)
	{
		bVar0 = func_355(794259616, uParam0->f_1, 1, "");
		DEBUG::_0xF0783374333FD8CE(680, 84, "RPG_GLOBAL_STATS_IS_STAT_FLAG_TUNABLE_ENABLED - Stat Flag: ", func_330(*uParam0, 0), " is has Tunable Enabled State: ", MISC::_0xF216F74101968DB0(bVar0));
		return bVar0;
	}
	return true;
}
...
void func_332(int iParam0)
{
	...
	DEBUG::_0xF0783374333FD8CE(40, 84, "__RPG_GLOBAL_STATS__PRIVATE__ACTIVATE_STAT_FLAG - Now Enabling Stat Flag: ", func_330(iParam0, 0));
	iVar0 = PLAYER::PLAYER_PED_ID();
	iVar1 = PLAYER::PLAYER_ID();
	switch (iParam0)
	{
...
void func_333(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(40, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - Attempting to play Activation Sound: ", func_359(iParam0, 0));
	sVar0 = func_360(iParam0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - There is no sound name associated with Activation Sound: ", func_359(iParam0, 0), " not playing anything...");
		return;
	}
	DEBUG::_0x1B08D1EB9D8C4931(680, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - Found sound name: ", sVar0, " associated with Activation Sound: ", func_359(iParam0, 0));
	sVar1 = func_361(iParam0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar1))
	{
		DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - There is no sound set associated with Activation Sound: ", func_359(iParam0, 0), " not playing anything...");
		return;
	}
	DEBUG::_0x1B08D1EB9D8C4931(680, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - Found sound set: ", sVar1, " associated with Activation Sound: ", func_359(iParam0, 0));
	DEBUG::_0xF0783374333FD8CE(10920, 84, "__RPG_GLOBAL__STATS__PLAY_PERK_SOUND - Playing sound name: ", sVar0, " in sound set: ", sVar1, " for Activation Sound: ", func_359(iParam0, 0));
...
bool func_340(bool bParam0, bool bParam1, float fParam2, char* sParam3)
{
	struct<11> Var0;
	bool bVar22;

	if (func_362(bParam0, bParam1, &Var0))
	{
...
bool func_341(int iParam0)
{
	...
	DEBUG::_0xA308F935BDECCEC0(168, 84, "RPG_GLOBAL_STATS__ADD_STAT_ID_TO_UPDATE_QUEUE - adding stat ", func_342(iParam0, 0), " to update queue. Total stats in queue: ", Global_1146683.f_2165);
	return true;
}
...
void func_346()
{
	...
	{
		if (!func_263(Global_1277758[Global_1275959 /*87*/].f_86, 1))
		{
...
char* func_348(int iParam0)
{
	...
	DEBUG::_0x9A6C65DDDBEC9C52(168, 84, "RPG_GLOBAL_GET_STAT_FLAG_POSTFX_NAME - Stat Flag: ", func_330(iParam0, 0), " does not have a Post FX name. Should you set one up? ");
	return "";
}
...
int func_349(int iParam0)
{
	...
	DEBUG::_0x9A6C65DDDBEC9C52(168, 84, "RPG_GLOBAL_GET_STAT_FLAG_PTFX_SCRIPT_ID - Stat Flag: ", func_330(iParam0, 0), " does not have a Particle FX. Should you set one up? ");
	return 0;
}
...
bool func_353(int iParam0, int iParam1)
{
	...
	if (func_302(Global_1146683.f_35859.f_3116[iVar0 /*31*/]))
	{
		iVar3 = Global_1146683.f_35859.f_9286[func_326(iVar2, 1) /*3*/];
		Var4 = { func_354(iVar3) };
		if (iVar3 != iParam0 && Global_1146683.f_35859.f_3116[iVar0 /*31*/].f_5 <= Var4.f_5)
		{
			DEBUG::_0x1B08D1EB9D8C4931(680, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - A stronger perk in the perk stack group: ", func_304(iVar2, 0), " is already active. Active Perk: ", func_282(iVar3, 0));
			return false;
		}
	}
	DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Evaluating Activation Trigger: ", func_363(Global_1146683.f_35859.f_3116[iVar0 /*31*/], 0), " for activation... ");
	switch (Global_1146683.f_35859.f_3116[iVar0 /*31*/])
	{
		...
		case 2116793692:
			DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_282(iParam0, 0), " can be activated! ");
			return true;
		case joaat("ENTER_FREEROAM_OR_COOP"):
			if (!func_364() && !func_365())
			{
				DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_282(iParam0, 0), " can only be activated when you are in Free Roam or running COOP. Returning FALSE. ");
				return false;
			}
			DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_282(iParam0, 0), " can be activated! ");
			return true;
		case -2010146101:
			if (!func_364())
			{
				DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_282(iParam0, 0), " can only be activated when you are in Free Roam. Returning FALSE. ");
				return false;
			}
			DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_282(iParam0, 0), " can be activated! ");
			return true;
		case joaat("ENTER_REVIVED_REMOTE"):
			...
			{
				DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_282(iParam0, 0), " can only be activated from REMOTE players. Returning FALSE. ");
				return false;
			}
			DEBUG::_0x1B08D1EB9D8C4931(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_282(iParam0, 0), " can be activated from Remote Player Index: ", iVar1);
			return true;
		case -2129621195:
			iVar1 = func_298(iParam1);
			if (iVar1 == Global_1275959)
		...
		case joaat("ALLY_ENTER_DEADEYE"):
			...
			if (iVar1 != Global_1275959 && !func_262(Global_1275959.f_154[iVar1]))
			{
	...
	DEBUG::_0x6D2A5155B260E879(168, 84, "__RPG_GLOBAL__STATS_CAN_PERK_BE_ACTIVATED - Perk: ", func_282(iParam0, 0), " has no activation logic defined, fix this... ");
	return false;
}
...
bool func_355(bool bParam0, bool bParam1, bool bParam2, char* sParam3)
{
	struct<11> Var0;
	bool bVar22;
...
char* func_356(int iParam0, int iParam1)
{
	...
	DEBUG::_0x9A6C65DDDBEC9C52(168, 84, "RPG_GLOBAL_GET_STAT_FLAG_PTFX_BONE - Stat Flag: ", func_330(iParam0, 0), " does not have a Particle FX bone. Should you set one up? ");
	return "";
}
...
bool func_362(bool bParam0, bool bParam1, var uParam2)
{
	struct<5> Var0;
	int iVar7;
	...
	if (DATAFILE::_0x44B3A36933AC009C(&iVar7, &Var0, joaat("NAME")))
	{
		*uParam2 = bParam0;
		...
		uParam2->f_10.f_3 = func_367(iVar7);
...
bool func_365()
{
	...
	if (func_370(Global_524288.f_40400))
	{
